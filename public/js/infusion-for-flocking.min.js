...
!function(y, b) {
    ...
    b.allocateGuid = function() {
        ...
        var a, i, s = o.constraint ? b.priorityTypes[o.constraint.type] : 0;
        return 0 !== s && (a = o.constraint.target || "none", void 0 === (i = b.extremalPriorities[a]) && b.fail("Unrecognised extremal priority target " + a + ": the currently supported values are " + b.keys(b.extremalPriorities).join(", ") + ": register your value in fluid.extremalPriorities"), 
        o.fixed = s * (b.extremePriority + i)), null !== o.fixed && (o.fixed += o.count / 1024), 
        o;
        ...
        var e = (a = a || {}).name || "<anonymous>", s = {
            ...
            addListener: function() {
                (function() {
                    s.listeners = {}, s.byId = {}, s.sortedListeners = [], s.addListener = function(e, t, n, r, o) {
                        var a, i;
                        s.destroyed && b.fail("Cannot add listener to destroyed event firer " + s.name), 
                        e && (b.isPlainObject(e, !0) && !b.isApplicable(e) && (e = (a = e).listener, t = a.namespace, 
                        n = a.priority, r = a.softNamespace, o = a.listenerId), "string" == typeof e && (e = {
                            globalName: e
                        }), i = o || b.event.identifyListener(e), t = t || i, a = y.extend(a || {}, {
                            namespace: t,
                            listener: e,
                            softNamespace: r,
                            listenerId: o,
            ...
            removeListener: function(e) {
                var t, n, r, o, a;
                s.listeners && ("string" == typeof e ? (a = e, (n = s.listeners[a]) || (t = a, a = null)) : "function" == typeof e && ((t = b.event.identifyListener(e, !0)) || b.fail("Cannot remove unregistered listener function ", e, " from event " + s.name)), 
                o = (r = s.byId[t]) && r.softNamespace, a = a || r && r.namespace || t, delete s.byId[t], 
                (n = s.listeners[a]) && (o ? b.remove_if(n, function(e) {
                    return e.listener.$$fluid_guid === t || e.listenerId === t;
                }) : n.shift(), 0 === n.length && delete s.listeners[a]), s.sortedListeners = b.event.sortListeners(s.listeners));
            },
            fire: function() {
        ...
        b.each(e, function(e, t) {
            var n, r, o;
            b.isIoCReference(t) ? (n = b.expandImmediate(t, i)) || b.fail("Error in listener record: key " + t + ' could not be looked up to an event firer - did you miss out "events." when referring to an event firer?') : (-1 !== (o = t.indexOf(".")) && (r = t.substring(o + 1), 
            t = t.substring(0, o)), s[t] || b.fail("Listener registered for event " + t + " which is not defined for this component"), 
            n = s[t]);
    ...
    b.defaultsStore = {}, b.resolveGradesImpl = function(e, t) {
        ...
        function e(e, t, n, r, o, a) {
            ...
            !b.isPrimitive(e)) {
                ...
                for (var s, l, u, c = b.concreteTrundler(a, t), d = b.derefMergePolicy(c), f = d.replace ? (s = 1 - o.length, 
                l = 0, -1) : (s = 0, l = o.length - 1, 1), p = [], m = s; m <= l; ++m) {
                    var g = f * m, h = v.sourceStrategies[g](o[g], t, n, r);
                    if (void 0 !== h && (b.isPrimitive(h) || (p[g] = h), void 0 === i)) {
                        if (-1 === f) {
                            u = e[t] = h;
                            break;
                        }
                        u = b.mergeOneImpl(u, h, m, p, d, n, r, v), e !== b.inEvaluationMarker && (e[t] = u);
                    }
                }
                return void 0 !== i && (u = i), 0 < p.length && b.isPlainObject(u) && b.fetchMergeChildren(u, n, r, p, c, v), 
                void 0 === i && 0 === p.length && delete e[t], u;
            }
        }
        return v.strategy = e;
    ...
    b.computeDynamicComponents = b.identity, b.mergeRecordTypes = {
        ...
        function o() {
            ...
            }), b.sortByPriority(l), b.dedupeDistributionNamespaces(l), c.length = 0, d.length = 0, 
            b.each(l, function(e) {
                c.push(e.strategy), d.push(e.target);
            });
        }
        var a = b.rawDefaults(t), i = b.getMergedDefaults(t, a && a.gradeNames ? null : r.gradeNames), s = {}, l = [], l = b.expandComponentOptions ? l.concat(b.expandComponentOptions(s, i, n, e)) : l.concat([ b.simpleGingerBlock(i, "defaults"), b.simpleGingerBlock(n, "user") ]), u = {}, c = [], d = [], f = {
            target: u,
            sourceStrategies: c
        };
        o();
        var p, m, g = b.makeMergeOptions(s, d, f);
        function h() {
            m = b.driveStrategy(u, "mergePolicy", g.strategy), m = y.extend({}, b.rootMergePolicy, m), 
            p = b.compileMergePolicy(m), y.extend(!0, s, p.builtins);
        }
        g.mergeBlocks = l, g.updateBlocks = o, g.destroyValue = function(e) {
            for (var t = 0; t < l.length; ++t) l[t].immutableTarget || b.destroyValue(l[t].target, e);
            b.destroyValue(f.target, e);
        }, h(), g.computeMergePolicy = h, p.hasDefaults && (b.generateExpandBlock ? (l.push(b.generateExpandBlock({
            options: p.defaultValues,
            recordType: "defaultValueMerge",
            priority: b.mergeRecordTypes.defaultValueMerge
        }, e, {})), o()) : b.fail("Cannot operate mergePolicy ", m, " for component ", e, " without including FluidIoC.js")), 
        ...
        return v && (b.transformOptionsBlocks(l, v, [ "user", "subcomponentRecord" ]), o()), 
    ...
    b.invokersMergePolicy = function(a, e) {
        return a = a || {}, b.each(e, function(e, t) {
            if (e) {
                ...
                var n = (n = a[t]) || (a[t] = {});
                for (var r in b.invokerStrategies) if (r in e) for (var o in b.invokerStrategies) n[o] = void 0;
                y.extend(n, e);
            } else a[t] = e;
        }), a;
    }, b.rootMergePolicy = {
    ...
    b.parseSelector = function(e, t) {
        ...
        for (var n = b.flattenObjectPaths(t), r = (r = b.keys(n)).sort(b.compareStringLength()), o = 0; o < r.length; ++o) for (var a = r[o], i = "%" + a, s = n[a], l = -1; -1 !== (l = e.indexOf(i)); ) e = e.slice(0, l) + s + e.slice(l + i.length);
        return e;
    };
}(jQuery, fluid_3_0_0);
        ...
        return (t = r.extend({
            ...
            if (null === t) o("null"); else if (void 0 === t) o("undefined"); else if (t === d.SYNTHETIC_PROPERTY) o("[Synthetic property]"); else if (d.isPrimitive(t) && !i) o(JSON.stringify(t)); else {
                ...
                if (r.stack.push(t), d.isArrayable(t)) if (0 === t.length) o("[]"); else {
                    for (o("[\n" + a), l = 0; l < t.length; ++l) {
                        if (e(t[l], a, r)) return 1;
                        l !== t.length - 1 && o(",\n" + a);
                    }
                    o("\n" + n + "]");
                } else {
                    o("{" + (i ? " Function" : "") + "\n" + a);
                    for (var s = d.keys(t), l = 0; l < s.length; ++l) {
                        var u = s[l], c = d.getSafeProperty(t, u);
                        if (o(JSON.stringify(u) + ": "), e(c, a, r)) return 1;
                        l !== s.length - 1 && o(",\n" + a);
                    }
                    o("\n" + n + "}");
                }
...
!function(d, h) {
    ...
    h.visitComponentChildren = function(e, t, n, r) {
        ...
        for (var r = 0; r < e.length; ++r) var o = h.expandImmediate(e[r], n), a = h.isPlainObject(a) ? d.extend(!0, a, o) : o;
        return a;
        ...
        return h.each(e, function(n) {
            ...
            void 0 !== e && (l.push(h.makeDistributionRecord(t, n.source, o, a, i, n.recordType)), 
            r = d.extend({}, e), s && h.model.applyChangeRequest(n.source, {
                segs: o,
                type: "DELETE"
            }), h.each(i, function(e) {
                var t = h.get(r, e);
        ...
        a = n.getThatStack(t.contextThat), i = h.getMemberNames(n, a), s = h.computeTreeDistance(o, i), 
        t.priority = h.mergeRecordTypes.distribution - s), t;
    ...
    h.distributeOptions = function(m, e) {
        ...
        h.each(t, function(e) {
            ...
            var i, s, l, u, c, d, f, p = h.model.parseEL(a.path);
            ...
            s = h.parseExpectedOptionsPath(i.path, "source"), l = h.makeArray(e.exclusions).concat(0 === s.length ? h.undistributableOptions : []), 
            u = h.transform(l, function(e) {
                return h.model.parseEL(e);
            }), c = h.filterBlocks(m, g.mergeOptions.mergeBlocks, s, p, u, e.removeSource), 
        ...
        var s, l, u, c = h.mountStrategy([ "events" ], e, r.eventStrategyBlock.strategy, [ "events" ]);
        ...
        r.contextHash["fluid.resolveRoot"] && (l = r.contextHash["fluid.resolveRootSingle"] ? ((s = h.getForComponent(e, [ "options", "singleRootType" ])) || h.fail("Cannot register object with grades " + Object.keys(r.contextHash).join(", ") + " as fluid.resolveRootSingle since it has not defined option singleRootType"), 
        h.typeNameToMemberName(s)) : h.computeGlobalMemberName(e), (u = h.resolveRootComponent)[l] && n.clearComponent(u, l), 
        n.recordKnownComponent(u, e, l, !1)), r.getConfig;
    ...
    h.filterBuiltinGrades = function(e) {
        ...
        function i(e, t, n, r, o) {
            ...
            a.injectedPaths[n] = !0, i = c.idToShadow[e.id], s = h.keys(a.contextHash), h.remove_if(s, function(e) {
        ...
        return d.extend(c, {
            ...
            var s, l = c.composePath(r, t), u = c.idToShadow[a.id];
            u && (s = u.path === l, c.events.onComponentClear.fire(a, l, e, s), s ? (h.visitComponentChildren(a, function(e, t, n, r) {
                var o = c.composeSegments.apply(null, n.slice(0, r));
                c.clearComponent(a, t, null, i, !0, o);
            }, i, c.parseEL(l)), h.doDestroy(a, t, e), i.destroyRecs.push({
                child: a,
                childShadow: u,
                name: t,
                component: e,
                shadow: o
            })) : h.remove_if(u.injectedPaths, function(e, t) {
                return t === l;
            }), h.clearChildrenScope(c, o, a, u), delete c.pathToComponent[l], n || (delete e[t], 
    ...
    function s(t, e, n, r) {
        ...
        var s = h.mergeRecordsToList(r, i);
        return h.transform(s, function(e) {
    ...
    h.fabricateDestroyMethod = function(e, t, n, r) {
        ...
        return h.each(r, function(e, t) {
            ...
            } : (n = s[t], h.expandImmediate(n, o, s)), c[e] = r;
        }), {
            args: c,
            funcName: e
        };
        ...
        if (!e[t]) {
            var r, o, a, i = e.options.components[t], s = h.globalInstantiator, l = s.idToShadow[e.id], u = n || l.subcomponentLocal && l.subcomponentLocal[t];
            return h.pushActivity("initDependent", 'instantiating dependent component at path "%path" with record %record as child of %parent', {
                path: l.path + "." + t,
                record: i,
                parent: e
            }), "string" == typeof i || i.expander ? (e[t] = h.inEvaluationMarker, (a = h.expandImmediate(i, e)) ? s.recordKnownComponent(e, a, t, !1) : delete e[t]) : i.type ? ((r = h.expandImmediate(i.type, e, u)) || h.fail("Error in subcomponent record: ", i.type, " could not be resolved to a type for component ", t, " of parent ", e), 
        ...
        return l.args || r ? (t = h.makeEventFirer({
            name: " [composite] " + h.event.nameEvent(i, s)
        }), n = h.event.dispatchListener(i, t.fire, s, l, r), r ? h.event.listenerEngine(c, n, u) : u(c).addListener(n)) : (t = {
            typeName: "fluid.event.firer",
            fire: function() {
    ...
    h.expandCompactRec = function(n, r, e) {
        ...
        var s = n ? e.indexOf(n, i + 1) : e.length, l = e.substring(i + 1, s);
...
!function(n, y) {
    ...
    y.model.makeEnvironmentStrategy = function(r) {
        ...
        var l = y.model.makeTrundler(r), u = s(u = {
            root: e,
            segs: o
        }, t, l);
        return t.path && u && (u = l(u, t.path)), a ? u : u ? u.root : void 0;
    ...
    y.clearLinkCounts = function(n, r) {
        ...
        var i, s, l, u;
        return "string" == typeof n ? y.isIoCReference(n) ? -1 === (s = (i = y.parseModelReference(e, n)).segs.indexOf("model")) ? r ? i.nonModel = !0 : o(' must be a reference into a component model via a path including the segment "model"') : (i.modelSegs = i.segs.slice(s + 1), 
        i.contextSegs = i.segs.slice(0, s), delete i.path) : i = {
            path: n,
        ...
        }), u = i.context ? ((l = y.resolveContext(i.context, e)) || o(" context must be a reference to an existing component"), 
        i.contextSegs ? y.getForComponent(l, i.contextSegs) : l) : e, i.nonModel || (y.isComponent(u) || a(u), 
        u.applier || y.getForComponent(u, [ "applier" ]), u.applier || a(u)), i.that = u, 
        i.applier = u && u.applier, i.path || (i.path = u && u.applier.composeSegments.apply(null, i.modelSegs)), 
        i;
        ...
        var l = {
            ...
            generateAdapters: function(e) {
                var t;
                l.forwardAdapterImpl = y.transformToAdapter(e ? e.newHolder.model : l.forwardHolder.model, o), 
                null !== r && ((t = y.model.transform.invertConfiguration(n)) !== y.model.transform.uninvertibleTransform ? (l.backwardHolder.model = t, 
                l.backwardAdapterImpl = y.transformToAdapter(l.backwardHolder.model, r)) : l.backwardAdapterImpl = t);
            },
        ...
        var r, o, a = t.segs.length, i = 0 === a, s = i ? {
            root: e,
            last: "model"
        } : (e.model || (e.model = {}, y.model.setChangedPath(n, [], n.inverse ? "DELETE" : "ADD")), 
        y.model.stepTargetAccess(e.model, t.type, t.segs, 0, a - 1, n));
        return "ADD" === t.type ? (r = t.value, o = y.makeArray(t.segs), y.model.applyChangeStrategy(s.root, s.last, a - 1, o, r, n, i)) : "DELETE" === t.type ? s.root && void 0 !== s.root[s.last] && (delete s.root[s.last], 
        ...
        var r, o, a = y.typeCode(e), i = y.typeCode(t), s = "primitive" === a && "primitive" === i ? y.model.isSameValue(e, t) : !("primitive" === a ^ "primitive" === i) && (r = {
            model: y.copy(e)
        ...
        return !1 === s && 0 === n.changes ? (n.changes = 1, n.changeMap = void 0 === t ? "DELETE" : "ADD") : !0 === s && 0 === n.unchanged && (n.unchanged = 1), 
        s;
        ...
        return n.extend(l, {
            ...
            var r = "relay" === (e = "init" === t ? null : e || "local"), o = {
                ...
                commit: function(e) {
                    var t;
                    l.preCommit.fire(o, l, e), 0 < o.changeRecord.changes && (t = {
                        model: i.model
...
!function(l, c) {
    ...
    c.registerNamespace("fluid.model.transform"), c.defaults("fluid.transformFunction", {
        ...
        return c.hasGrade(t, "fluid.standardOutputTransformFunction") && void 0 !== (void 0 !== r.outputPath ? r.outputPath : e.doOutput ? "" : void 0) && void 0 !== l && (c.model.transform.setValue(r.outputPath, l, o), 
        l = void 0), l;
    };
    var n = [];
    c.registerNamespace("fluid.pathUtil"), c.pathUtil.getPathSegment = function(e, t) {
        ...
        c.each(e, function(e, t) {
            ...
            for (var r, o, a, i = 0; i < n.length; ++i) {
                c.pathUtil.matchPath(n[i].matchPath, s.path, !0) && (void 0 !== (r = c.copy(n[i].transformSpec)).inputPath && !c.model.transform.hasWildcard(r.inputPath) || (r.inputPath = ""), 
                s.inputPrefixOp.push(s.path), s.outputPrefixOp.push(s.path), o = c.model.transform.lookupType(r.type), 
                void 0 !== (a = c.model.transform.doTransform(r, s, o)) && c.model.transform.setValue(null, a, s), 
                s.outputPrefixOp.pop(), s.inputPrefixOp.pop());
            }
        ...
        var i, s = r.collectInputPaths;
        s && (i = c.makeArray(c.invokeGlobalFunction(s, [ e, t ])), Array.prototype.push.apply(t.inputPaths, i));
...
!function(l, u) {
    ...
    u.defaults("fluid.transforms.identity", {
        ...
        return u.each(o.match, function(e, t) {
            var n, r;
            !0 !== e.outputUndefinedValue && (n = {}, void 0 === (r = l(s ? e.inputValue : t, o.defaultInputValue)) && u.fail("Failure inverting configuration for valueMapper - inputValue could not be resolved for record " + t + ": ", o), 
...
!function(p, m) {
    ...
    m.defaults("fluid.viewComponent", {
    ...
    }, m.createDomBinder = function(l, u) {
        var c = {
            id: m.allocateGuid(),
            cache: {}
        }, d = l.constructor;
        ...
        return c.locate = function(e, t) {
            var n, r, o, a, i, s = u[e];
            if (void 0 !== s) return (i = t ? p(t) : l) || m.fail("DOM binder invoked for selector " + e + " without container"), 
            (n = "" === s ? i : s ? "function" == typeof s ? d(s.call(null, m.unwrap(i))) : d(s, i) : d()).selector || (n.selector = s, 
            n.context = i), n.selectorName = e, r = e, o = i, a = n, c.cache[f(r, o)] = a, n;
        }, c.fastLocate = function(e, t) {
            var n = f(e, t || l), r = c.cache[n];
