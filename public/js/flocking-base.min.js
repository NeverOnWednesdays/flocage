...
!function() {
    ...
    t.ArrayMath || (e = {
        ...
        sampleLinear: function(e, t, n) {
            for (var o = t.length - 1, r = Math.min(e.length, n.length) - 1; 0 <= r; --r) {
                var a = (a = n[r]) < 0 ? 0 : o < a ? o : a, i = Math.floor(a), l = a - i, u = t[i], s = t[i < o ? i + 1 : o];
                e[r] = u + l * (s - u);
            }
        },
        ...
        sampleCubic: function(e, t, n) {
            for (var o = t.length - 1, r = Math.min(e.length, n.length) - 1; 0 <= r; --r) {
                var a = (a = n[r]) < 0 ? 0 : o < a ? o : a, i = Math.floor(a), l = a - i, u = l * l, s = u * l, f = -2 * s + 3 * u, c = 1 - f, d = s - u, m = d - u + l, h = t[0 < i ? i - 1 : 0], p = t[i], k = t[i < o ? i + 1 : o], g = t[i < o - 1 ? i + 2 : o];
    ...
    t.Filter || ((e = function(e, t) {
        ...
        for (var n = this._a, o = n.length, r = this._b, a = r.length, i = this._aHist, l = this._bHist, u = t.length, s = e.length, f = a - 1, c = o, d = 0; (f || c) && d < u; ++d) {
            ...
            f && f--;
            var h = r[0] * t[d];
            for (C = 1; C < m; ++C) h += r[C] * t[d - C];
            for (;C < a; ++C) h += r[C] * l[C - m];
            for (m = o - c, c && c--, C = 0; C < m; ++C) h -= n[C] * e[d - 1 - C];
            for (;C < o; ++C) h -= n[C] * i[C - m];
            e[d] = h;
        }
        if (3 == a && 2 == o) for (var p, k, g = r[0], v = r[1], y = r[2], b = n[0], w = n[1], A = t[d - 1], N = t[d - 2], M = e[d - 1], S = e[d - 2]; d < u; ++d) p = N, 
        N = A, k = S, M = g * (A = t[d]) + v * N + y * p - b * (S = M) - w * k, e[d] = M; else for (;d < u; ++d) {
            var C, h = r[0] * t[d];
            for (C = 1; C < a; ++C) h += r[C] * t[d - C];
            for (C = 0; C < o; ++C) h -= n[C] * e[d - 1 - C];
            e[d] = h;
        }
    ...
    var y, e, t = "undefined" != typeof window ? window : "undefined" != typeof self ? self : "undefined" != typeof module && module.exports ? module.exports : global;
    t.FFT || (y = function(e, t, n, o, r, a, i, l, u, s, f, c, d, m) {
        ...
        switch (n = k, h) {
          ...
          case 3:
            !function(e, t, n, o, r, a, i) {
                for (var l, u, s, f, c, d, m, h, p, k, g, v, y, b, w, A, N = 0, M = 0, S = 2 * o, C = n, I = n + i, x = n + 2 * i, D = a[o * i], L = .5773502691896258, P = C + i; C < P; ) p = e[C] * L, 
          ...
          case 4:
            !function(e, t, n, o, r, a, i, l) {
                for (var u, s, f, c, d, m, h, p, k, g, v, y, b, w, A, N, M, S, C, I, x, D, L = 0, P = 0, O = 0, F = 2 * o, B = 3 * o, R = n, T = n + i, E = n + 2 * i, V = n + 3 * i, U = R + i; R < U; ) b = .5 * e[R], 
                w = .5 * t[R], A = .5 * e[T], N = .5 * t[T], M = .5 * e[E], S = .5 * t[E], C = .5 * e[V], 
                I = .5 * t[V], u = A * (x = r[L]) - N * (D = a[L]), s = A * D + N * x, v = b - (f = M * (x = r[P]) - S * (D = a[P])), 
                y = w - (c = M * D + S * x), b += f, w += c, h = u + (d = C * (x = r[O]) - I * (D = a[O])), 
                p = s + (m = C * D + I * x), k = u - d, g = s - m, e[E] = b - h, t[E] = w - p, e[R] = b + h, 
                t[R] = w + p, l ? (e[T] = v - g, t[T] = y + k, e[V] = v + g, t[V] = y - k) : (e[T] = v + g, 
                t[T] = y - k, e[V] = v - g, t[V] = y + k), L += o, P += F, O += B, ++R, ++T, ++E, 
                ++V;
            }(e, t, n, i, f, c, p, m);
            break;
          ...
          case 5:
            !function(e, t, n, o, r, a, i) {
                for (var l, u, s, f, c, d, m, h, p, k, g, v, y, b, w, A, N, M, S, C, I, x, D, L, P, O, F, B, R, T, E, V, U, q, G, _, W, z, j = 0, H = 0, K = 0, J = 0, Q = 2 * o, X = 3 * o, Y = 4 * o, $ = n, Z = n + i, ee = n + 2 * i, te = n + 3 * i, ne = n + 4 * i, oe = r[o * i], re = a[o * i], ae = r[2 * o * i], ie = a[2 * o * i], le = .4472135954999579, ue = $ + i; $ < ue; ) F = e[$] * le, 
                B = t[$] * le, R = e[Z] * le, T = t[Z] * le, E = e[ee] * le, V = t[ee] * le, U = e[te] * le, 
                q = t[te] * le, G = e[ne] * le, _ = t[ne] * le, l = F, u = B, s = R * (W = r[j]) - T * (z = a[j]), 
                f = R * z + T * W, c = E * (W = r[H]) - V * (z = a[H]), d = E * z + V * W, m = U * (W = r[K]) - q * (z = a[K]), 
                h = U * z + q * W, w = s + (p = G * (W = r[J]) - _ * (z = a[J])), A = f + (k = G * z + _ * W), 
                I = s - p, x = f - k, N = c + m, M = d + h, S = c - m, C = d - h, e[$] = F + w + N, 
                t[$] = B + A + M, g = l + w * oe + N * ae, v = u + A * oe + M * ae, y = x * re + C * ie, 
                b = -I * re - S * ie, e[Z] = g - y, t[Z] = v - b, e[ne] = g + y, t[ne] = v + b, 
                D = l + w * ae + N * oe, L = u + A * ae + M * oe, P = -x * ie + C * re, O = I * ie - S * re, 
                e[ee] = D + P, t[ee] = L + O, e[te] = D - P, t[te] = L - O, j += o, H += Q, K += X, 
                J += Y, ++$, ++Z, ++ee, ++te, ++ne;
            }(e, t, n, i, f, c, p);
            break;
          ...
          default:
            !function(e, t, n, o, r, a, i, l, u) {
                for (var s, f, c, d, m, h, p, k = new Float32Array(l), g = new Float32Array(l), v = Math.sqrt(1 / l), y = 0; y < i; ++y) {
                    for (s = n + y, w = 0; w < l; ++w) k[w] = e[s] * v, g[w] = t[s] * v, s += i;
                    s = n + y;
                    for (var b = o * y, w = 0; w < l; ++w) {
                        f = k[0], c = g[0];
                        for (var A = 0, N = 1; N < l; ++N) u <= (A += b) && (A -= u), d = k[N], m = g[N], 
                        f += d * (h = r[A]) - m * (p = a[A]), c += d * p + m * h;
                        e[s] = f, t[s] = c, s += i, b += o;
                    }
                }
            }(e, t, n, i, f, c, p, h, d);
...
Random.prototype.exponential = function(e) {
    ...
    if (!(1 < e)) {
        ...
        for (;;) {
            ...
            s = r <= 1 ? Math.pow(r, 1 / e) : -Math.log((o - r) / e);
            a = this.random();
            if (1 < r) {
    ...
    for (var a, i = Math.sqrt(2 * e - 1), l = e - this.LOG4, u = e + i; ;) {
        if (!((a = this.random()) < 1e-7 || .9999999 < n)) {
            var s, f = 1 - this.random(), c = Math.log(a / (1 - a)) / i, d = a * a * f, m = l + u * c - (s = e * Math.exp(c));
    ...
    return this.lastNormal = NaN, r || (n = 2 * this.random() * Math.PI, o = Math.sqrt(-2 * Math.log(1 - this.random())), 
    r = Math.cos(n) * o, this.lastNormal = Math.sin(n) * o), e + r * t;
...
!function() {
    ...
    flock.LOG001 = Math.log(.001), flock.ROOT2 = Math.sqrt(2), flock.rates = {
        ...
        var e = navigator.userAgent.toLowerCase(), t = {}, n = /(chrome)[ \/]([\w.]+)/.exec(e) || /(webkit)[ \/]([\w.]+)/.exec(e) || /(opera)(?:.*version|)[ \/]([\w.]+)/.exec(e) || /(msie) ([\w.]+)/.exec(e) || e.indexOf("compatible") < 0 && /(mozilla)(?:.*? rv:([\w.]+)|)/.exec(e) || [], o = {
            browser: n[1] || "",
            version: n[2] || "0"
        };
        return o.browser && (t[o.browser] = !0, t.version = o.version), t.chrome ? t.webkit = !0 : t.webkit && (t.safari = !0), 
        t;
    ...
    flock.shim = {
        ...
        return l *= flock.TWOPI, flock.generateBuffer(e, function(e) {
            for (var t, n, o = 0, r = 0; r < i; r++) t = u ? u[r] : 1, n = (r + 1) * (e * a), 
            o += t * Math.cos(n + l);
            return o;
        });
        ...
        for (var t, n = {
            ...
            min: 1 / 0
        }, o = 0; o < e.length; o++) (t = e[o]) > n.max && (n.max = t), t < n.min && (n.min = t);
        return n;
        ...
        void 0 === n && (n = e.length);
        for (var o = new Float32Array(n - t), r = t, a = 0; r < n; r++, a++) o[a] = e[r];
        return o;
        ...
        linear: function(e, t) {
            var n = t.length, o = 0 | (e %= n), r = (1 + o) % n, a = e - o, i = t[o];
            return i + a * (t[r] - i);
        },
        hermite: function(e, t) {
            var n = t.length, o = Math.floor(e), r = o % n, a = e - o, i = (1 + r) % n, l = (2 + r) % n, u = t[0 < r ? r - 1 : n - 1], s = t[r], f = t[i], c = .5 * (f - u), d = s - f, m = c + d, h = m + d + .5 * (t[l] - s);
        ...
        return "string" == typeof e && (e = {
            buffer: e
        }), "string" == typeof e.buffer && (o = e.buffer, e.buffer = t[o], e.buffer.id = o), 
        ...
        for (var n = [], o = 0; o < e; o++) n[o] = new Float32Array(t);
        return n;
        ...
        var o;
        void 0 === t && (t = e.options.addToEnvironment), null != t && !1 !== t && ("string" == (o = typeof t) && "head" === t || "tail" === t ? flock.nodeList[t](n, e) : "number" == o ? flock.nodeList.insert(n, e, t) : flock.nodeList.tail(n, e));
...
fluid.defaults("flock.synth", {
    ...
    if (null == t) return n;
    for (var r, a, i = flock.parse.ugenDef(t, e.enviro, {
        audioSettings: e.audioSettings,
        buses: e.enviro.busManager.buses,
        buffers: e.enviro.buffers
    }), l = flock.isIterable(i) ? i : void 0 !== i ? [ i ] : [], u = flock.isIterable(n) ? n : void 0 !== n ? [ n ] : [], s = Math.min(l.length, u.length), f = o ? "swapTree" : "replaceTree", c = 0; c < s; c++) r = flock.ugenNodeList[f](e.nodeList, l[c], u[c]);
    for (a = c; a < l.length; a++) r++, flock.ugenNodeList.insertTree(e.nodeList, l[a], r);
    for (a = c; a < u.length; a++) flock.ugenNodeList.removeTree(e.nodeList, u[a]);
    return i;
};
...
!function() {
    ...
    fluid.defaults("flock.promise", {
        ...
        e = e || [];
        for (var t, n, o = [], r = 0; r < e.length; r++) t = e[r], n = flock.bufferLoader.idFromURL(t), 
        o.push({
            id: n,
            url: t
        });
        ...
        var o = 1, r = {
            setBuffer: function(e) {
                var t;
                n.buffers.push(e), n.buffers.length === n.options.bufferDefs.length ? n.events.afterBuffersLoaded.fire(n.buffers) : o < n.bufferDefs.length && (t = n.bufferDefs[o], 
...
!function() {
    ...
    fluid.registerNamespace("flock.parse"), flock.parse.synthDef = function(e, t, n) {
        ...
        var r, a, i = o.audioSettings.rates, l = o.audioSettings.blockSize;
        ...
        flock.debug.failHard || (r = e.rate, e.rate = flock.rates.AUDIO, flock.log.warn("Overriding invalid unit generator rate. Rate is now '" + e.rate + "'; was: " + fluid.prettyPrintJSON(r)))), 
        ...
        var u = e.rate === flock.rates.AUDIO ? l : 1;
        if (flock.hasTag(e.options, "flock.ugen.multiChannelOutput")) for (var s = e.options.numOutputs || 1, f = [], c = 0; c < s; c++) f.push(new Float32Array(u)); else f = new Float32Array(u);
        var d = fluid.copy(e.options);
        return d.buffers = o.buffers, d.buses = o.buses, d.enviro = n, flock.invoke(void 0, e.ugen, [ t, f, d ]);
    ...
    flock.parse.expandInputs = function(e) {
        ...
        for (var o = [], r = 0; r < e.length; r++) o[r] = flock.parse.ugenForDef(e[r], t, n);
        return o;
        ...
        var o = (n = m.extend(!0, {
            ...
            buffers: t.buffers
        }, n)).visitors, r = n.audioSettings.rates;
        ...
        var a, i = (e = flock.parse.ugenDef.mergeOptions(e, n)).inputs, l = {};
        for (a in i) {
            var u = i[a];
            null !== u && (l[a] = flock.input.shouldExpand(a, e) ? flock.parse.ugenForDef(u, t, n) : u);
        }
        ...
        var s = flock.parse.makeUGen(e, l, t, n);
        if (e.id && (s.id = e.id), s.options.ugenDef = e, o) for (var f = 0; f < o.length; f++) o[f](s, e, r);
        return s;
...
(flock = fluid.registerNamespace("flock")).applyDeferred = function(e, t, n) {
    ...
    i && (r = atob(r)), flock.applyDeferred(function() {
...
fluid.registerNamespace("flock.audio.encode"), flock.audio.interleave = function(e) {
    for (var t, n = e.format.numSampleFrames, o = e.data.channels, r = e.format.numChannels, a = new Float32Array(n * r), i = 0, l = 0; l < n; l++) for (t = 0; t < r; t++) a[i] = o[t][l], 
    i++;
    return a;
    ...
    (2 < r || !i) && (l += 12, u = 2 < r ? (l += 24, 65534) : (l += 2, 3));
...
(flock = fluid.registerNamespace("flock")).shim = {
    ...
    var o;
    e && (-1 < (o = t.indexOf(e)) ? (t.splice(o, 1), n(e)) : e.wrappedListener && flock.scheduler.removeListener(e.wrappedListener, t, n));
...
flock.webAudio.shouldSetProperty = function(e) {
    ...
    var n = t.inputs;
    for (var o in n) for (var r = n[o], a = parseInt(o, 10), r = fluid.makeArray(r), i = 0; i < r.length; i++) {
        var l = r[i];
...
fluid.defaults("flock.midi.system", {
    ...
    return function(e) {
        for (var t in a) {
            var n, o = e[t], r = a[t];
            if (!(n = "*" === r || o && -1 < o.toLowerCase().indexOf(r.toLowerCase()))) break;
        }
        return n;
    };
...
fluid.defaults("flock.webAudio.outputManager", {
    ...
    var t, n, o = this.inputNodes ? this.inputNodes.length : 0, r = this.nodeList.nodes, a = this.model.audioSettings, i = e.inputBuffer, l = e.outputBuffer, u = a.numBlocks, s = this.buses, f = a.numBuses, c = a.blockSize, d = a.chans, m = i.numberOfChannels;
    if (r.length < 1) for (t = 0; t < d; t++) flock.clearBuffer(l.getChannelData(t)); else for (n = 0; n < u; n++) {
        var h = n * c;
        if (flock.evaluate.clearBuses(s, f, c), 0 < o) for (t = 0; t < m; t++) for (var p = i.getChannelData(t), k = s[d + t], g = 0; g < c; g++) k[g] = p[g + h];
        for (flock.evaluate.synths(r), t = 0; t < d; t++) {
            var v = s[t], y = l.getChannelData(t);
            for (g = 0; g < c; g++) y[g + h] = v[g];
        }
    }
};
...
!function() {
    ...
    flock.ugenDefaults = function(e, t) {
        ...
        for (var o = n.output[0], r = 0; r < e; r++) t[r] = t[r] * o;
    }, flock.mul = function(e, t, n) {
        for (var o = n.output, r = 0; r < e; r++) t[r] = t[r] * o[r];
    }, flock.krAdd = function(e, t, n, o) {
        for (var r = o.output[0], a = 0; a < e; a++) t[a] = t[a] + r;
    }, flock.add = function(e, t, n, o) {
        for (var r = o.output, a = 0; a < e; a++) t[a] = t[a] + r[a];
    }, flock.krMulAdd = function(e, t, n, o) {
        for (var r = n.output[0], a = o.output, i = 0; i < e; i++) t[i] = t[i] * r + a[i];
    }, flock.mulKrAdd = function(e, t, n, o) {
        for (var r = n.output, a = o.output[0], i = 0; i < e; i++) t[i] = t[i] * r[i] + a;
    }, flock.krMulKrAdd = function(e, t, n, o) {
        for (var r = n.output[0], a = o.output[0], i = 0; i < e; i++) t[i] = t[i] * r + a;
    }, flock.mulAdd = function(e, t, n, o) {
        for (var r = n.output, a = o.output, i = 0; i < e; i++) t[i] = t[i] * r[i] + a[i];
        ...
        return l.lastOutputIdx = l.output.length - 1, l.get = function(e) {
            ...
            for (var e, t, n, o = l.options.multiInputNames, r = l.multiInputs, a = 0; a < o.length; a++) (t = r[e = o[a]]) ? t.length = 0 : t = r[e] = [], 
            n = l.inputs[e], flock.ugen.collectMultiInputs(n, t);
            ...
            for (var e, t, n, o = fluid.makeArray(l.options.tags), r = l.model, a = l.options, i = 0; i < o.length; i++) l.tags.push(o[i]);
            e = a.audioSettings = a.audioSettings || l.enviro.audioSystem.model, r.sampleRate = a.sampleRate || e.rates[l.rate], 
            r.nyquistRate = r.sampleRate, r.blockSize = l.rate === flock.rates.AUDIO ? e.blockSize : 1, 
            r.sampleDur = 1 / r.sampleRate, l.interpolate = flock.interpolate.none, a.interpolation && ((n = flock.interpolate[a.interpolation]) ? l.interpolate = n : fluid.log(fluid.logLevel.IMPORTANT, "An invalid interpolation type of '" + a.interpolation + "' was specified. Defaulting to none.")), 
            l.rate === flock.rates.DEMAND && l.inputs.freq && (t = flock.parse.ugenDefForConstantValue(1), 
            l.inputs.freq = flock.parse.ugenDef(t, l.enviro));
        }, l.init(), l;
        ...
        for (var n = flock.hasTag(e, "flock.ugen.multiChannelOutput") ? e.output : [ e.output ], o = 0; o < n.length; o++) t.push({
            rate: e.rate,
            output: n[o]
        });
        return t;
        ...
        return i.gen = function(e) {
            for (var t, n = i.model, o = i.inputs.source.output, r = i.output, a = 0; a < o.length; a++) r[a] = t = o[a];
            for (;a < e; a++) r[a] = t = 0;
        ...
        return k.gen = function(e) {
            var t, n, o, r, a, i, l, u, s = k.model, f = k.multiInputs.sources, c = k.options.buses, d = k.inputs.bus.output[0], m = k.inputs.expand.output[0], h = f.length, p = Math.max(m, h);
            if (!(h < 1)) {
                for (t = 0; t < p; t++) {
                    for (r = (o = f[t % h]).rate, a = c[d + t], i = r === flock.rates.AUDIO ? 1 : 0, 
                    n = l = 0; n < e; n++, l += i) u = o.output[l], a[n] = a[n] + u;
                    k.mulAddFn(e, a, k.inputs.mul, k.inputs.add);
                }
                s.value = s.unscaledValue = u;
            }
        }, k.init = function() {
        ...
        return o.arraySourceGen = function() {
            for (var e = o.model, t = o.inputs.sources, n = 0; n < t.length; n++) e.value[n] = t[n].output[0];
        ...
        return u.singleBusGen = function(e) {
            ...
            for (var t, n, o = u.model, r = u.inputs.bus, a = u.options.buses, i = u.output, l = 0; l < e; l++) {
                for (t = n = 0; t < r.length; t++) n += a[0 | r[t].output[0]][l];
                i[l] = n;
            }
            o.unscaledValue = n, u.mulAdd(e), o.value = flock.ugen.lastOutputValue(e, i);
        ...
        for (var r = o[0 | n.output[0]], a = 0; a < e; a++) t[a] = r[a];
        ...
        var i = flock.ugen(e, t, n);
        return i.gen = function(e) {
            for (var t, n = i.model, o = i.output, r = i.bus, a = 0; a < e; a++) o[a] = t = r[a];
