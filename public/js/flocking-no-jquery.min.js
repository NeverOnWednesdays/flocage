...
!function(n, r) {
    "object" == typeof exports ? (n.flock = exports, r(0, require("jquery"))) : "function" == typeof define && define.amd ? define([ "exports", "jquery" ], function(e, t) {
        return n.flock = e, n.flock, r(0, t);
    }) : (n.flock = {}, r(n.flock, jQuery));
}(this, function(e, t) {
    window.jQuery = t;
    var n, r, a, o, b, i, u, s = s || {}, m = m || s;
    !function(y, b) {
        "use strict";
        ...
        b.renderOneActivity = function(e, t) {
            ...
            for (var n = 0; n < e.length; n++) {
                for (var r = e[n], a = n; 0 < a && t(r, e[a - 1]) < 0; a--) e[a] = e[a - 1];
                e[a] = r;
            }
        ...
        b.allocateGuid = function() {
            ...
            var o, i, u = a.constraint ? b.priorityTypes[a.constraint.type] : 0;
            return 0 !== u && (o = a.constraint.target || "none", void 0 === (i = b.extremalPriorities[o]) && b.fail("Unrecognised extremal priority target " + o + ": the currently supported values are " + b.keys(b.extremalPriorities).join(", ") + ": register your value in fluid.extremalPriorities"), 
            a.fixed = u * (b.extremePriority + i)), null !== a.fixed && (a.fixed += a.count / 1024), 
            a;
            ...
            for (var t = b.find(e, function(e, t) {
                ...
                for (var n, r = t, a = t; a < e.length; ++a) {
                    b.honourConstraint(e, t, a) && ++t;
                }
                t === r && (n = e.slice(t), b.fail("Could not find targets for any constraints in " + n[0].priority.site + " ", n, ": none of the targets (" + b.getMembers(n, "priority.constraint.target").join(", ") + ") matched any namespaces of the elements in (", e.slice(0, t), ") - this is caused by either an invalid or circular reference"));
            }
            ...
            return n && ((t = b.getGlobalValue(n)) ? e = t : b.fail("Unable to look up name " + n + " as a global function")), 
            e;
            ...
            var e = (o = o || {}).name || "<anonymous>", u = {
                ...
                addListener: function() {
                    (function() {
                        u.listeners = {}, u.byId = {}, u.sortedListeners = [], u.addListener = function(e, t, n, r, a) {
                            var o, i;
                            u.destroyed && b.fail("Cannot add listener to destroyed event firer " + u.name), 
                            e && (b.isPlainObject(e, !0) && !b.isApplicable(e) && (e = (o = e).listener, t = o.namespace, 
                            n = o.priority, r = o.softNamespace, a = o.listenerId), "string" == typeof e && (e = {
                                globalName: e
                            }), i = a || b.event.identifyListener(e), t = t || i, o = y.extend(o || {}, {
                                namespace: t,
                                listener: e,
                                softNamespace: r,
                                listenerId: a,
                ...
                removeListener: function(e) {
                    var t, n, r, a, o;
                    u.listeners && ("string" == typeof e ? (o = e, (n = u.listeners[o]) || (t = o, o = null)) : "function" == typeof e && ((t = b.event.identifyListener(e, !0)) || b.fail("Cannot remove unregistered listener function ", e, " from event " + u.name)), 
                    a = (r = u.byId[t]) && r.softNamespace, o = o || r && r.namespace || t, delete u.byId[t], 
                    (n = u.listeners[o]) && (a ? b.remove_if(n, function(e) {
                        return e.listener.$$fluid_guid === t || e.listenerId === t;
                    }) : n.shift(), 0 === n.length && delete u.listeners[o]), u.sortedListeners = b.event.sortListeners(u.listeners));
                },
                fire: function() {
            ...
            b.each(e, function(e, t) {
                var n, r, a;
                b.isIoCReference(t) ? (n = b.expandImmediate(t, i)) || b.fail("Error in listener record: key " + t + ' could not be looked up to an event firer - did you miss out "events." when referring to an event firer?') : (-1 !== (a = t.indexOf(".")) && (r = t.substring(a + 1), 
                t = t.substring(0, a)), u[t] || b.fail("Listener registered for event " + t + " which is not defined for this component"), 
                n = u[t]);
        ...
        b.defaultsStore = {}, b.resolveGradesImpl = function(e, t) {
            ...
            function e(e, t, n, r, a, o) {
                ...
                !b.isPrimitive(e)) {
                    ...
                    for (var u, s, l, c = b.concreteTrundler(o, t), d = b.derefMergePolicy(c), f = d.replace ? (u = 1 - a.length, 
                    s = 0, -1) : (u = 0, s = a.length - 1, 1), p = [], m = u; m <= s; ++m) {
                        var g = f * m, h = v.sourceStrategies[g](a[g], t, n, r);
                        if (void 0 !== h && (b.isPrimitive(h) || (p[g] = h), void 0 === i)) {
                            if (-1 === f) {
                                l = e[t] = h;
                                break;
                            }
                            l = b.mergeOneImpl(l, h, m, p, d, n, r, v), e !== b.inEvaluationMarker && (e[t] = l);
                        }
                    }
                    return void 0 !== i && (l = i), 0 < p.length && b.isPlainObject(l) && b.fetchMergeChildren(l, n, r, p, c, v), 
        ...
        b.computeDynamicComponents = b.identity, b.mergeRecordTypes = {
            ...
            var o = b.rawDefaults(t), i = b.getMergedDefaults(t, o && o.gradeNames ? null : r.gradeNames), u = {}, s = [], s = b.expandComponentOptions ? s.concat(b.expandComponentOptions(u, i, n, e)) : s.concat([ b.simpleGingerBlock(i, "defaults"), b.simpleGingerBlock(n, "user") ]), l = {}, c = [], d = [], f = {
                target: l,
                sourceStrategies: c
            };
            a();
            var p, m, g = b.makeMergeOptions(u, d, f);
            function h() {
                m = b.driveStrategy(l, "mergePolicy", g.strategy), m = y.extend({}, b.rootMergePolicy, m), 
                p = b.compileMergePolicy(m), y.extend(!0, u, p.builtins);
            }
            g.mergeBlocks = s, g.updateBlocks = a, g.destroyValue = function(e) {
            ...
            }, e, {})), a()) : b.fail("Cannot operate mergePolicy ", m, " for component ", e, " without including FluidIoC.js")), 
            ...
            return v && (b.transformOptionsBlocks(s, v, [ "user", "subcomponentRecord" ]), a()), 
        ...
        b.invokersMergePolicy = function(o, e) {
            return o = o || {}, b.each(e, function(e, t) {
                if (e) {
                    ...
                    var n = (n = o[t]) || (o[t] = {});
                    for (var r in b.invokerStrategies) if (r in e) for (var a in b.invokerStrategies) n[a] = void 0;
                    y.extend(n, e);
                } else o[t] = e;
            }), o;
        }, b.rootMergePolicy = {
            ...
            var r;
            return "function" != typeof t ? "fluid.emptySubcomponent" === (r = "string" == typeof t ? t : t.type) ? null : b.invokeGlobalFunction(r, n) : t.apply(null, n);
        };
        var r = "(?:[\\w\\u00c0-\\uFFFF*_-";
        b.simpleCSSMatcher = {
        ...
        b.parseSelector = function(e, t) {
            ...
            return b.each(e, function(e, n) {
                var t;
                null !== e && "object" == typeof e ? (t = b.flattenObjectPaths(e), b.each(t, function(e, t) {
                    r[n + "." + t] = e;
                }), "function" == typeof b.get(e, "toString") && (r[n] = e.toString())) : r[n] = e;
            }), r;
        }, b.stringTemplate = function(e, t) {
            for (var n = b.flattenObjectPaths(t), r = (r = b.keys(n)).sort(b.compareStringLength()), a = 0; a < r.length; ++a) for (var o = r[a], i = "%" + o, u = n[o], s = -1; -1 !== (s = e.indexOf(i)); ) e = e.slice(0, s) + u + e.slice(s + i.length);
            return e;
        };
    }(t, s), function(r, d) {
        "use strict";
            ...
            return (t = r.extend({
                ...
                if (null === t) a("null"); else if (void 0 === t) a("undefined"); else if (t === d.SYNTHETIC_PROPERTY) a("[Synthetic property]"); else if (d.isPrimitive(t) && !i) a(JSON.stringify(t)); else {
                    ...
                    if (r.stack.push(t), d.isArrayable(t)) if (0 === t.length) a("[]"); else {
                        for (a("[\n" + o), s = 0; s < t.length; ++s) {
                            if (e(t[s], o, r)) return 1;
                            s !== t.length - 1 && a(",\n" + o);
                        }
                        a("\n" + n + "]");
                    } else {
                        a("{" + (i ? " Function" : "") + "\n" + o);
                        for (var u = d.keys(t), s = 0; s < u.length; ++s) {
                            var l = u[s], c = d.getSafeProperty(t, l);
                            if (a(JSON.stringify(l) + ": "), e(c, o, r)) return 1;
                            s !== u.length - 1 && a(",\n" + o);
                        }
                        a("\n" + n + "}");
                    }
        ...
        h.visitComponentChildren = function(e, t, n, r) {
            ...
            for (var r = 0; r < e.length; ++r) var a = h.expandImmediate(e[r], n), o = h.isPlainObject(o) ? d.extend(!0, o, a) : a;
            return o;
            ...
            return h.each(e, function(n) {
                var r, e = h.get(n.source, a);
                void 0 !== e && (s.push(h.makeDistributionRecord(t, n.source, a, o, i, n.recordType)), 
                r = d.extend({}, e), u && h.model.applyChangeRequest(n.source, {
                    segs: a,
                    type: "DELETE"
                }), h.each(i, function(e) {
                    var t = h.get(r, e);
            ...
            var n, r, a, o, i, u;
            return t.priority || (r = (n = h.getInstantiator(e)).getThatStack(e), a = h.getMemberNames(n, r), 
            o = n.getThatStack(t.contextThat), i = h.getMemberNames(n, o), u = h.computeTreeDistance(a, i), 
        ...
        h.distributeOptions = function(m, e) {
            ...
            h.each(t, function(e) {
                ...
                var t, n, r, a, o = h.parseContextReference(e.target);
                h.isIoCSSSelector(o.context) ? (n = h.parseSelector(o.context, h.IoCSSMatcher), 
                "/" === (a = h.extractSelectorHead(n)) ? t = h.rootComponent : r = a) : r = o.context, 
                (t = t || h.resolveContext(r, m)) || h.fail("Error in options distribution record ", e, " - could not resolve context {" + r + "} to a head component");
                var i, u, s, l, c, d, f, p = h.model.parseEL(o.path);
                ...
                n ? (d = h.pushDistributions(t, n, e.target, c), g.outDistributions = g.outDistributions || [], 
                g.outDistributions.push({
                    targetHeadId: t.id,
                    distributionId: d
                })) : (f = h.shadowForComponent(t), h.applyDistributions(m, c, f)), h.popActivity();
            });
            ...
            h.each(t, function(r, a) {
                ...
                r.sources ? (e = h.expandOptions(r.sources, o), h.each(e, function(e, t) {
                    var n = h.registerDynamicRecord(o, a, t, r, "sources");
                    u[n] = {
                        source: e,
                        sourcePath: t
                    };
                })) : r.createOnEvent && (t = h.event.expandOneEvent(o, r.createOnEvent), h.set(i, [ "dynamicComponentCount", a ], 0), 
                n = function() {
            ...
            return r.memberStrategy = h.recordStrategy(e, a, o, "members", h.memberFromRecord, null, {
                model: !0,
                modelRelay: !0
            }), r.getConfig = {
            ...
            return function(e, t, n, r) {
                ...
                1 < n ? u : void 0 === u && e.hasOwnProperty(t) ? h.NO_VALUE : (void 0 === u && (a = s.idToShadow[e.id].path, 
                o = s.composePath(a, t), u = s.pathToComponent[o]), void 0 !== u || (i = h.getForComponent(e, [ "options", "components", t ])) && (i.createOnEvent && h.fail('Error resolving path segment "' + t + '" of path ' + r.join(".") + " since component with record ", i, ' has annotation "createOnEvent" - this very likely represents an implementation error. Either alter the reference so it does not  match this component, or alter your workflow to ensure that the component is instantiated by the time this reference resolves'), 
        ...
        h.filterBuiltinGrades = function(e) {
            ...
            function i(e, t, n, r, a) {
                var o, i, u;
                a ? ((o = c.idToShadow[t.id] = {}).that = t, o.path = n, o.memberName = r, h.constructScopeObjects(c, e, t, o)) : ((o = c.idToShadow[t.id]).injectedPaths = o.injectedPaths || {}, 
                o.injectedPaths[n] = !0, i = c.idToShadow[e.id], u = h.keys(o.contextHash), h.remove_if(u, function(e) {
            ...
            return d.extend(c, {
                ...
                var a, o;
                e[n] = t, h.isComponent(t) || "instantiator" === t.type ? (a = c.idToShadow[e.id].path, 
                i(e, t, o = c.composePath(a, n), n, r), c.events.onComponentAttach.fire(t, o, c, r)) : h.fail("Cannot record non-component with value ", t, ' at path "' + n + '" of parent ', e);
                ...
                var u, s = c.composePath(r, t), l = c.idToShadow[o.id];
                l && (u = l.path === s, c.events.onComponentClear.fire(o, s, e, u), u ? (h.visitComponentChildren(o, function(e, t, n, r) {
                    var a = c.composeSegments.apply(null, n.slice(0, r));
                    c.clearComponent(o, t, null, i, !0, a);
                }, i, c.parseEL(s)), h.doDestroy(o, t, e), i.destroyRecs.push({
                    child: o,
                    childShadow: l,
                    name: t,
                    component: e,
                    ...
                    return t === s;
                }), h.clearChildrenScope(c, a, o, l), delete c.pathToComponent[s], n || (delete e[t], 
        ...
        function u(t, e, n, r) {
            var a, o = h.copy(e);
            a = t, h.each([ "gradeNames", "mergePolicy", "argumentMap", "components", "dynamicComponents", "events", "listeners", "modelListeners", "modelRelay", "distributeOptions", "transformOptions" ], function(e) {
                h.set(a, [ e, "*", "noexpand" ], !0);
            ...
            d.extend(i, n.mergeRecords), i.subcomponentRecord && h.checkComponentRecord(i.subcomponentRecord);
        ...
        h.fabricateDestroyMethod = function(e, t, n, r) {
            ...
            return h.each(r, function(e, t) {
                ...
                } : (n = u[t], h.expandImmediate(n, a, u)), c[e] = r;
            }), {
                args: c,
                funcName: e
            };
            ...
            if (!e[t]) {
                var r, a, o, i = e.options.components[t], u = h.globalInstantiator, s = u.idToShadow[e.id], l = n || s.subcomponentLocal && s.subcomponentLocal[t];
                return h.pushActivity("initDependent", 'instantiating dependent component at path "%path" with record %record as child of %parent', {
                    path: s.path + "." + t,
                    record: i,
                    parent: e
                }), "string" == typeof i || i.expander ? (e[t] = h.inEvaluationMarker, (o = h.expandImmediate(i, e)) ? u.recordKnownComponent(e, o, t, !1) : delete e[t]) : i.type ? ((r = h.expandImmediate(i.type, e, l)) || h.fail("Error in subcomponent record: ", i.type, " could not be resolved to a type for component ", t, " of parent ", e), 
                a = h.assembleCreatorArguments(e, r, {
                    componentRecord: i,
                    memberName: t,
                    localDynamic: l
                }), o = h.initSubcomponentImpl(e, {
                    type: a.funcName
                }, a.args)) : h.fail("Unrecognised material in place of subcomponent " + t + ' - no "type" field found'), 
                h.popActivity(), o;
            }
            ...
            var e, a, t = h.shadowForComponent(r);
            ...
            h.each(n, function(e, t) {
                a(e).addListener(function() {
                    var e;
                    o[t] = h.makeArray(arguments), h.find(n, function(e, t) {
        ...
        h.expandCompactRec = function(n, r, e) {
            ...
            t = t || 0;
            var r, a, o = "{" === e.charAt(t + 1), i = o ? (a = h.parseContextReference(e, t + 1, "}")).endpos : e.indexOf("}", t + 1);
            -1 === i && h.fail('Cannot parse context reference "' + e + '": Malformed context reference without }'), 
            r = o ? a : e.substring(t + 1, i);
            ...
            var i, u;
            h.guardCircularExpansion(o, o.length), h.isIoCReference(r) ? (i = h.parseContextReference(r), 
        ...
        y.model.makeEnvironmentStrategy = function(r) {
            ...
            return t.path && l && (l = s(l, t.path)), o ? l : l ? l.root : void 0;
        ...
        y.clearLinkCounts = function(n, r) {
            ...
            return y.transform(i, function(e, n) {
                ...
                y.each(t, function(e) {
                    var t;
                    !e.isRelay || y.isExcludedChangeSource(o[n], e.cond) || (t = e.targetId) !== n && (r[t] = !0);
                });
            ...
            var i, u, s, l;
            return "string" == typeof n ? y.isIoCReference(n) ? -1 === (u = (i = y.parseModelReference(e, n)).segs.indexOf("model")) ? r ? i.nonModel = !0 : a(' must be a reference into a component model via a path including the segment "model"') : (i.modelSegs = i.segs.slice(u + 1), 
            i.contextSegs = i.segs.slice(0, u), delete i.path) : i = {
                path: n,
                modelSegs: e.applier.parseEL(n)
            } : (y.isArrayable(n.segs) || a(' must contain an entry "segs" holding path segments referring a model path within a component'), 
            i = {
                context: n.context,
                modelSegs: y.expandOptions(n.segs, e)
            }), l = i.context ? ((s = y.resolveContext(i.context, e)) || a(" context must be a reference to an existing component"), 
            i.contextSegs ? y.getForComponent(s, i.contextSegs) : s) : e, i.nonModel || (y.isComponent(l) || o(l), 
            l.applier || y.getForComponent(l, [ "applier" ]), l.applier || o(l)), i.that = l, 
            ...
            var s = {
                ...
                generateAdapters: function(e) {
                    var t;
                    s.forwardAdapterImpl = y.transformToAdapter(e ? e.newHolder.model : s.forwardHolder.model, a), 
            ...
            var i, t;
            return y.isIoCReference(e) ? (t = y.parseValidModelReference(r, "model reference from model (implicit relay)", e, !0)).nonModel ? i = y.getForComponent(t.that, t.segs) : (++o.refCount, 
            y.connectModelRelay(r, a, t.that, t.modelSegs, o)) : y.isPrimitive(e) || !y.isPlainObject(e) ? i = e : e.expander && y.isPlainObject(e.expander) ? i = y.expandOptions(e, r) : (i = y.freshContainer(e), 
            ...
            for (var i = r; i < a; ++i) {
                e && e[n[i]] !== (e = y.model.traverseWithStrategy(e, n, i, o["ADD" === t ? "resolverSetConfig" : "resolverGetConfig"], n.length - i - 1)) && o.changeMap && y.model.setChangedPath(o, n.slice(0, i + 1), "ADD");
            }
            return {
                root: e,
                last: n[a]
            ...
            var r, a, o = t.segs.length, i = 0 === o, u = i ? {
                root: e,
                last: "model"
            } : (e.model || (e.model = {}, y.model.setChangedPath(n, [], n.inverse ? "DELETE" : "ADD")), 
            y.model.stepTargetAccess(e.model, t.type, t.segs, 0, o - 1, n));
            return "ADD" === t.type ? (r = t.value, a = y.makeArray(t.segs), y.model.applyChangeStrategy(u.root, u.last, o - 1, a, r, n, i)) : "DELETE" === t.type ? u.root && void 0 !== u.root[u.last] && (delete u.root[u.last], 
            ...
            var r, a, o = y.typeCode(e), i = y.typeCode(t), u = "primitive" === o && "primitive" === i ? y.model.isSameValue(e, t) : !("primitive" === o ^ "primitive" === i) && (r = {
                model: y.copy(e)
                ...
                model: y.copy(t)
            }, n.inverse = !0, y.model.applyHolderChangeRequest(a, {
                value: e,
                segs: [],
                type: "ADD"
            }, n), 0 === n.changes);
            ...
            return n.extend(s, {
                ...
                var r = "relay" === (e = "init" === t ? null : e || "local"), a = {
                    ...
                    commit: function(e) {
                        var t;
                        s.preCommit.fire(a, s, e), 0 < a.changeRecord.changes && (t = {
                            model: i.model
        ...
        c.registerNamespace("fluid.model.transform"), c.defaults("fluid.transformFunction", {
            ...
            var o, i = [ r, a ];
            if (c.hasGrade(t, "fluid.multiInputTransformFunction") && (o = {}, c.each(t.inputVariables, function(t, n) {
                o[n] = function() {
                    var e = c.model.transform.getValue(r[n + "Path"], r[n], a);
                    return e = void 0 === e && null !== t ? t : e;
                };
            }), i.unshift(o)), c.hasGrade(t, "fluid.standardInputTransformFunction")) {
            ...
            return c.hasGrade(t, "fluid.standardOutputTransformFunction") && void 0 !== (void 0 !== r.outputPath ? r.outputPath : e.doOutput ? "" : void 0) && void 0 !== s && (c.model.transform.setValue(r.outputPath, s, a), 
            s = void 0), s;
        };
        var n = [];
        c.registerNamespace("fluid.pathUtil"), c.pathUtil.getPathSegment = function(e, t) {
            ...
            c.each(e, function(e, t) {
                ...
                for (var r, a, o, i = 0; i < n.length; ++i) {
                    ...
                    u.inputPrefixOp.push(u.path), u.outputPrefixOp.push(u.path), a = c.model.transform.lookupType(r.type), 
                    void 0 !== (o = c.model.transform.doTransform(r, u, a)) && c.model.transform.setValue(null, o, u), 
            ...
            var r, a = n.defaults && n.defaults.invertConfiguration;
            a ? (r = c.invokeGlobalFunction(a, [ e, t ]), t.inverted.push(r)) : t.inverted.push(c.model.transform.uninvertibleTransform);
            ...
            e.transform) if (c.isArrayable(e.transform)) for (var a = e.transform, o = void 0, i = 0; i < a.length; ++i) t = a[i], 
            n = c.model.transform.lookupType(t.type), r.transformHandler(t, r, n); else t = e.transform, 
            n = c.model.transform.lookupType(t.type), o = r.transformHandler(t, r, n);
        ...
        l.defaults("fluid.transforms.identity", {
            ...
            return l.each(a.match, function(e, t) {
                var n, r;
                !0 !== e.outputUndefinedValue && (n = {}, void 0 === (r = s(u ? e.inputValue : t, a.defaultInputValue)) && l.fail("Failure inverting configuration for valueMapper - inputValue could not be resolved for record " + t + ": ", a), 
    ...
    }(s = s || {}), (r = "undefined" != typeof window ? window : "undefined" != typeof self ? self : "undefined" != typeof module && module.exports ? module.exports : global).ArrayMath || (n = {
        add: function(e, t, n) {
            var r;
        ...
        sampleLinear: function(e, t, n) {
            for (var r = t.length - 1, a = Math.min(e.length, n.length) - 1; 0 <= a; --a) {
                var o = (o = n[a]) < 0 ? 0 : r < o ? r : o, i = Math.floor(o), u = o - i, s = t[i], l = t[i < r ? i + 1 : r];
                e[a] = s + u * (l - s);
            }
        },
        ...
        sampleCubic: function(e, t, n) {
            for (var r = t.length - 1, a = Math.min(e.length, n.length) - 1; 0 <= a; --a) {
                var o = (o = n[a]) < 0 ? 0 : r < o ? r : o, i = Math.floor(o), u = o - i, s = u * u, l = s * u, c = -2 * l + 3 * s, d = 1 - c, f = l - s, p = f - s + u, m = t[0 < i ? i - 1 : 0], g = t[i], h = t[i < r ? i + 1 : r], v = t[i < r - 1 ? i + 2 : r];
    ...
    }, r.ArrayMath = n), (o = "undefined" != typeof window ? window : "undefined" != typeof self ? self : "undefined" != typeof module && module.exports ? module.exports : global).Filter || ((a = function(e, t) {
        ...
        for (var n = this._a, r = n.length, a = this._b, o = a.length, i = this._aHist, u = this._bHist, s = t.length, l = e.length, c = o - 1, d = r, f = 0; (c || d) && f < s; ++f) {
            var p = o - c;
            c && c--;
            var m = a[0] * t[f];
            for (I = 1; I < p; ++I) m += a[I] * t[f - I];
            for (;I < o; ++I) m += a[I] * u[I - p];
            for (p = r - d, d && d--, I = 0; I < p; ++I) m -= n[I] * e[f - 1 - I];
            for (;I < r; ++I) m -= n[I] * i[I - p];
            e[f] = m;
        }
        if (3 == o && 2 == r) for (var g, h, v = a[0], y = a[1], b = a[2], k = n[0], S = n[1], C = t[f - 1], x = t[f - 2], A = e[f - 1], w = e[f - 2]; f < s; ++f) g = x, 
        x = C, h = w, A = v * (C = t[f]) + y * x + b * g - k * (w = A) - S * h, e[f] = A; else for (;f < s; ++f) {
            var I, m = a[0] * t[f];
            for (I = 1; I < o; ++I) m += a[I] * t[f - I];
            for (I = 0; I < r; ++I) m -= n[I] * e[f - 1 - I];
            e[f] = m;
        }
        var N = Math.min(o - 1, s);
        for (f = o - 2; N <= f; --f) u[f] = u[f - N];
        for (f = 0; f < N; ++f) u[f] = t[s - 1 - f];
        for (N = Math.min(r, l), f = r - 1; N <= f; --f) i[f] = i[f - N];
        for (f = 0; f < N; ++f) i[f] = e[s - 1 - f];
    }, a.prototype.clearHistory = function() {
        for (var e = this._bHist.length - 1; 0 <= e; --e) this._bHist[e] = 0;
        for (e = this._aHist.length - 1; 0 <= e; --e) this._aHist[e] = 0;
    }, a.prototype.setB = function(e) {
        for (var t = Math.min(this._b.length, e.length), n = 0; n < t; ++n) this._b[n] = e[n];
    }, a.prototype.setA = function(e) {
        for (var t = Math.min(this._a.length, e.length), n = 0; n < t; ++n) this._a[n] = e[n];
    }, o.Filter = a), (u = "undefined" != typeof window ? window : "undefined" != typeof self ? self : "undefined" != typeof module && module.exports ? module.exports : global).FFT || (b = function(e, t, n, r, a, o, i, u, s, l, c, d, f, p) {
        ...
        switch (n = h, m) {
          ...
          default:
            !function(e, t, n, r, a, o, i, u, s) {
                for (var l, c, d, f, p, m, g, h = new Float32Array(u), v = new Float32Array(u), y = Math.sqrt(1 / u), b = 0; b < i; ++b) {
                    for (l = n + b, S = 0; S < u; ++S) h[S] = e[l] * y, v[S] = t[l] * y, l += i;
                    l = n + b;
                    for (var k = r * b, S = 0; S < u; ++S) {
                        c = h[0], d = v[0];
                        for (var C = 0, x = 1; x < u; ++x) s <= (C += k) && (C -= s), f = h[x], p = v[x], 
                        c += f * (m = a[C]) - p * (g = o[C]), d += f * g + p * m;
                        e[l] = c, t[l] = d, l += i, k += r;
                    }
                }
            }(e, t, n, i, c, d, g, m, f);
    ...
    l.prototype.init_genrand = function(e) {
    ...
    }, l.prototype.init_by_array = function(e, t) {
        var n, r, a;
    ...
    }, l.prototype.genrand_int32 = function() {
        ...
        (e ^= e >>> 18) >>> 0;
    }, l.prototype.genrand_int31 = function() {
        return this.genrand_int32() >>> 1;
    }, l.prototype.genrand_real1 = function() {
    ...
    l.prototype.exponential = function(e) {
        ...
        if (!(1 < e)) {
            ...
            for (;;) {
                ...
                l = a <= 1 ? Math.pow(a, 1 / e) : -Math.log((r - a) / e);
                o = this.random();
                if (1 < a) {
                    if (o <= Math.pow(l, e - 1)) break;
                } else if (o <= Math.exp(-l)) break;
            }
            return l * t;
        }
        for (var o, i = Math.sqrt(2 * e - 1), u = e - this.LOG4, s = e + i; ;) {
            if (!((o = this.random()) < 1e-7 || .9999999 < n)) {
                var l, c = 1 - this.random(), d = Math.log(o / (1 - o)) / i, f = o * o * c, p = u + s * d - (l = e * Math.exp(d));
                if (0 <= p + this.SG_MAGICCONST - 4.5 * f || p >= Math.log(f)) return l * t;
            }
        }
    }, l.prototype.normal = function(e, t) {
        if (2 != arguments.length) throw new SyntaxError("normal() must be called with mu and sigma parameters");
        var n, r, a = this.lastNormal;
        return this.lastNormal = NaN, a || (n = 2 * this.random() * Math.PI, r = Math.sqrt(-2 * Math.log(1 - this.random())), 
        a = Math.cos(n) * r, this.lastNormal = Math.sin(n) * r), e + a * t;
    }, l.prototype.pareto = function(e) {
        if (1 != arguments.length) throw new SyntaxError("pareto() must be called with alpha parameter");
        var t = this.random();
        return 1 / Math.pow(1 - t, 1 / e);
    }, l.prototype.triangular = function(e, t, n) {
    ...
    }, l.prototype.uniform = function(e, t) {
    ...
    }, l.prototype.weibull = function(e, t) {
    ...
    }, "undefined" == typeof window && "undefined" != typeof module && module.exports && (module.exports = l);
    var D = (m = m || require("infusion")).registerNamespace("flock");
    !function() {
        "use strict";
        var e, o = m.registerNamespace("jQuery");
        D.fluid = m, D.init = function(e) {
            var t = e ? {
                components: {
                    audioSystem: {
                        options: {
        ...
        D.platform.audioEngine = D.platform.isBrowser ? "webAudio" : "unknown", D.platform.browser && void 0 !== D.platform.browser.version && (e = D.platform.browser.version.indexOf("."), 
        ...
        D.shim = {
            ...
            return u *= D.TWOPI, D.generateBuffer(e, function(e) {
                for (var t, n, r = 0, a = 0; a < i; a++) t = s ? s[a] : 1, n = (a + 1) * (e * o), 
                r += t * Math.cos(n + u);
                return r;
            });
            ...
            if (e) {
                for (var t = D.range(e), n = (t.max - t.min) / 2, r = (t.max + t.min) / 2, a = 0; a < e.length; a++) e[a] = (e[a] - r) / n;
                return e;
            }
        }, D.copyBuffer = function(e, t, n) {
            void 0 === n && (n = e.length);
            for (var r = new Float32Array(n - t), a = t, o = 0; a < n; a++, o++) r[o] = e[a];
            return r;
            ...
            if (t && "" !== t) {
                for (var n = "" === t ? [] : String(t).split("."), r = e[n[0]], a = 1; a < n.length; a++) {
                    if (null == r) return void D.pathParseError(e, t, n[a - 1]);
                    r = r[n[a]];
                }
                return r;
            }
            ...
            if (e && t && "" !== t) {
                for (var r = String(t).split("."), a = r.length, o = r[0], i = 1; i < a; i++) {
                    if ("object" != typeof (e = e[o])) return void D.fail("Error while setting a value at path '" + t + "'. A non-container object was found at segment '" + o + "'. Value: " + e);
                    void 0 === e[o = r[i]] && (e[o] = {});
                }
                return e[o] = n;
            }
            ...
            for (var t = m.model.parseEL(e), n = t.length - 1, r = [], a = 0; a < n; a++) {
                var o = t[a], i = t[a + 1];
                if (r.push(o), "model" === i || "options" === i) {
                    r = r.concat(t.slice(a + 1, n));
                    break;
                }
            ...
            for (var n, r = {}, a = 0; a < t.length; a++) r[n = t[a]] = D.input.get(e, n);
            return r;
            ...
            var r;
            void 0 === t && (t = e.options.addToEnvironment), null != t && !1 !== t && ("string" == (r = typeof t) && "head" === t || "tail" === t ? D.nodeList[t](n, e) : "number" == r ? D.nodeList.insert(n, e, t) : D.nodeList.tail(n, e));
    ...
    m.defaults("flock.synth", {
        ...
        if (null == t) return n;
        for (var a, o, i = D.parse.ugenDef(t, e.enviro, {
            audioSettings: e.audioSettings,
            buses: e.enviro.busManager.buses,
            buffers: e.enviro.buffers
        }), u = D.isIterable(i) ? i : void 0 !== i ? [ i ] : [], s = D.isIterable(n) ? n : void 0 !== n ? [ n ] : [], l = Math.min(u.length, s.length), c = r ? "swapTree" : "replaceTree", d = 0; d < l; d++) a = D.ugenNodeList[c](e.nodeList, u[d], s[d]);
        for (o = d; o < u.length; o++) a++, D.ugenNodeList.insertTree(e.nodeList, u[o], a);
        for (o = d; o < s.length; o++) D.ugenNodeList.removeTree(e.nodeList, s[o]);
        return i;
    };
    D = (m = m || require("infusion")).registerNamespace("flock");
    ...
    !function() {
        ...
        m.defaults("flock.promise", {
            ...
            e = e || [];
            for (var t, n, r = [], a = 0; a < e.length; a++) t = e[a], n = D.bufferLoader.idFromURL(t), 
            r.push({
                id: n,
                url: t
            });
    ...
    !function() {
        ...
        m.registerNamespace("flock.parse"), D.parse.synthDef = function(e, t, n) {
            ...
            var a, o, i = r.audioSettings.rates, u = r.audioSettings.blockSize;
            e.rate || (e.rate = D.rates.AUDIO), D.hasValue(D.rates, e.rate) || (D.fail("An invalid rate was specified for a unit generator. ugenDef was: " + m.prettyPrintJSON(e)), 
            D.debug.failHard || (a = e.rate, e.rate = D.rates.AUDIO, D.log.warn("Overriding invalid unit generator rate. Rate is now '" + e.rate + "'; was: " + m.prettyPrintJSON(a)))), 
            o = e.options && void 0 !== e.options.sampleRate ? e.options.sampleRate : i[e.rate], 
            ...
            var s = e.rate === D.rates.AUDIO ? u : 1;
            if (D.hasTag(e.options, "flock.ugen.multiChannelOutput")) for (var l = e.options.numOutputs || 1, c = [], d = 0; d < l; d++) c.push(new Float32Array(s)); else c = new Float32Array(s);
            var f = m.copy(e.options);
            return f.buffers = r.buffers, f.buses = r.buses, f.enviro = n, D.invoke(void 0, e.ugen, [ t, c, f ]);
        ...
        D.parse.expandInputs = function(e) {
            ...
            for (var r = [], a = 0; a < e.length; a++) r[a] = D.parse.ugenForDef(e[a], t, n);
            return r;
            ...
            var r = (n = p.extend(!0, {
                ...
                buffers: t.buffers
            }, n)).visitors, a = n.audioSettings.rates;
            ...
            var o, i = (e = D.parse.ugenDef.mergeOptions(e, n)).inputs, u = {};
            for (o in i) {
                var s = i[o];
                null !== s && (u[o] = D.input.shouldExpand(o, e) ? D.parse.ugenForDef(s, t, n) : s);
            }
            ...
            var l = D.parse.makeUGen(e, u, t, n);
            if (e.id && (l.id = e.id), l.options.ugenDef = e, r) for (var c = 0; c < r.length; c++) r[c](l, e, a);
            return l;
    ...
    !function() {
        ...
        m.registerNamespace("flock.audio.encode"), D.audio.interleave = function(e) {
            for (var t, n = e.format.numSampleFrames, r = e.data.channels, a = e.format.numChannels, o = new Float32Array(n * a), i = 0, u = 0; u < n; u++) for (t = 0; t < a; t++) o[i] = r[t][u], 
            i++;
            return o;
            ...
            (2 < a || !i) && (u += 12, s = 2 < a ? (u += 24, 65534) : (u += 2, 3));
    ...
    !function() {
        ...
        D.shim = {
            ...
            var r;
            e && (-1 < (r = t.indexOf(e)) ? (t.splice(r, 1), n(e)) : e.wrappedListener && D.scheduler.removeListener(e.wrappedListener, t, n));
    ...
    !function() {
        ...
        D.webAudio.shouldSetProperty = function(e) {
            ...
            var n = t.inputs;
            for (var r in n) for (var a = n[r], o = parseInt(r, 10), a = m.makeArray(a), i = 0; i < a.length; i++) {
                var u = a[i];
    ...
    !function() {
        ...
        D.midi.createSystemRealtimeMessageReaders = function(e) {
            ...
            return function(e) {
                for (var t in o) {
                    var n, r = e[t], a = o[t];
                    if (!(n = "*" === a || r && -1 < r.toLowerCase().indexOf(a.toLowerCase()))) break;
                }
                return n;
            };
    ...
    !function() {
        ...
        m.defaults("flock.webAudio.outputManager", {
            ...
            var t, n, r = this.inputNodes ? this.inputNodes.length : 0, a = this.nodeList.nodes, o = this.model.audioSettings, i = e.inputBuffer, u = e.outputBuffer, s = o.numBlocks, l = this.buses, c = o.numBuses, d = o.blockSize, f = o.chans, p = i.numberOfChannels;
            if (a.length < 1) for (t = 0; t < f; t++) D.clearBuffer(u.getChannelData(t)); else for (n = 0; n < s; n++) {
                var m = n * d;
                if (D.evaluate.clearBuses(l, c, d), 0 < r) for (t = 0; t < p; t++) for (var g = i.getChannelData(t), h = l[f + t], v = 0; v < d; v++) h[v] = g[v + m];
                for (D.evaluate.synths(a), t = 0; t < f; t++) {
                    var y = l[t], b = u.getChannelData(t);
                    for (v = 0; v < d; v++) b[v + m] = y[v];
                }
            }
        };
    }();
    ...
    !function() {
        ...
        D.ugenDefaults = function(e, t) {
            ...
            for (var r = n.output[0], a = 0; a < e; a++) t[a] = t[a] * r;
        }, D.mul = function(e, t, n) {
            for (var r = n.output, a = 0; a < e; a++) t[a] = t[a] * r[a];
        }, D.krAdd = function(e, t, n, r) {
            for (var a = r.output[0], o = 0; o < e; o++) t[o] = t[o] + a;
        }, D.add = function(e, t, n, r) {
            for (var a = r.output, o = 0; o < e; o++) t[o] = t[o] + a[o];
        }, D.krMulAdd = function(e, t, n, r) {
            for (var a = n.output[0], o = r.output, i = 0; i < e; i++) t[i] = t[i] * a + o[i];
        }, D.mulKrAdd = function(e, t, n, r) {
            for (var a = n.output, o = r.output[0], i = 0; i < e; i++) t[i] = t[i] * a[i] + o;
        }, D.krMulKrAdd = function(e, t, n, r) {
            for (var a = n.output[0], o = r.output[0], i = 0; i < e; i++) t[i] = t[i] * a + o;
        }, D.mulAdd = function(e, t, n, r) {
            for (var a = n.output, o = r.output, i = 0; i < e; i++) t[i] = t[i] * a[i] + o[i];
            ...
            return u.lastOutputIdx = u.output.length - 1, u.get = function(e) {
                ...
                for (var e, t, n, r = u.options.multiInputNames, a = u.multiInputs, o = 0; o < r.length; o++) (t = a[e = r[o]]) ? t.length = 0 : t = a[e] = [], 
                n = u.inputs[e], D.ugen.collectMultiInputs(n, t);
                ...
                for (var e, t, n, r = m.makeArray(u.options.tags), a = u.model, o = u.options, i = 0; i < r.length; i++) u.tags.push(r[i]);
                e = o.audioSettings = o.audioSettings || u.enviro.audioSystem.model, a.sampleRate = o.sampleRate || e.rates[u.rate], 
                a.nyquistRate = a.sampleRate, a.blockSize = u.rate === D.rates.AUDIO ? e.blockSize : 1, 
                a.sampleDur = 1 / a.sampleRate, u.interpolate = D.interpolate.none, o.interpolation && ((n = D.interpolate[o.interpolation]) ? u.interpolate = n : m.log(m.logLevel.IMPORTANT, "An invalid interpolation type of '" + o.interpolation + "' was specified. Defaulting to none.")), 
                u.rate === D.rates.DEMAND && u.inputs.freq && (t = D.parse.ugenDefForConstantValue(1), 
                u.inputs.freq = D.parse.ugenDef(t, u.enviro));
            }, u.init(), u;
        }, D.ugen.collectMultiInputs = function(e, t) {
            D.isIterable(e) || (e = m.makeArray(e));
            for (var n = 0; n < e.length; n++) {
                var r = e[n];
            ...
            for (var n = D.hasTag(e, "flock.ugen.multiChannelOutput") ? e.output : [ e.output ], r = 0; r < n.length; r++) t.push({
                rate: e.rate,
                output: n[r]
            });
            return t;
            ...
            return i.gen = function(e) {
                for (var t, n = i.model, r = i.inputs.source.output, a = i.output, o = 0; o < r.length; o++) a[o] = t = r[o];
                for (;o < e; o++) a[o] = t = 0;
                n.unscaledValue = t, i.mulAdd(e), n.value = D.ugen.lastOutputValue(e, a);
            }, i.onInputChanged(), i;
            ...
            return h.gen = function(e) {
                var t, n, r, a, o, i, u, s, l = h.model, c = h.multiInputs.sources, d = h.options.buses, f = h.inputs.bus.output[0], p = h.inputs.expand.output[0], m = c.length, g = Math.max(p, m);
                if (!(m < 1)) {
                    for (t = 0; t < g; t++) {
                        for (a = (r = c[t % m]).rate, o = d[f + t], i = a === D.rates.AUDIO ? 1 : 0, n = u = 0; n < e; n++, 
                        u += i) s = r.output[u], o[n] = o[n] + s;
                        h.mulAddFn(e, o, h.inputs.mul, h.inputs.add);
                    }
            ...
            return s.singleBusGen = function(e) {
                ...
                for (var t, n, r = s.model, a = s.inputs.bus, o = s.options.buses, i = s.output, u = 0; u < e; u++) {
                    for (t = n = 0; t < a.length; t++) n += o[0 | a[t].output[0]][u];
                    i[u] = n;
                }
                r.unscaledValue = n, s.mulAdd(e), r.value = D.ugen.lastOutputValue(e, i);
            ...
            for (var a = r[0 | n.output[0]], o = 0; o < e; o++) t[o] = a[o];
    ...
    !function() {
        ...
        D.blit = function(e) {
            ...
            return u.gen = function(e) {
                for (var t, n = u.model, r = u.output, a = u.inputs.freq.output[0], o = n.phase, i = 0; i < e; i++) --o < -2 && (D.blit.updatePeriodState(n, a), 
                o += n.d0), t = D.blit(o), r[i] = t;
                n.phase = o, n.unscaledValue = t, u.mulAdd(e), n.value = D.ugen.lastOutputValue(e, r);
            }, u.init = function() {
                u.onInputChanged();
            }, u.init(), u;
            ...
            return s.gen = function(e) {
                ...
                for (void 0 === i && (D.ugen.saw.updatePeriodState(n, a), i = n.d0 / 2), t = 0; t < e; t++) --i < -2 && (D.ugen.saw.updatePeriodState(n, a), 
            ...
            return c.gen = function(e) {
                ...
                a[t] = n * r.ampScale, --u < -2 && (D.ugen.tri.updatePeriodState(r, o), u += r.phaseResetValue);
    ...
    !function() {
        ...
        D.ugen.playBuffer = function(y, e, t) {
            ...
            return b.defaultKrTriggerGen = function(e) {
                ...
                for (var t, n, r, a, o = b.model, i = b.output, u = b.inputs.channel.output[0], s = b.inputs.speed.output, l = b.buffer.data.channels[u], c = y.trigger.output, d = o.idx, f = b.inputs.loop.output[0], p = b.inputs.start.output[0] * o.lastIdx | 0, m = b.inputs.end.output[0] * o.lastIdx | 0, g = 0, h = 0, v = 0; g < e; g++, 
                h += o.strides.trigger, v += o.strides.speed) {
                    if (t = c[h], n = o.prevTrig, r = s[v], 0 < (o.prevTrig = t) && n <= 0) d = D.ugen.playBuffer.resetIndex(r, p, m); else if (d < p || m < d) {
                        if (!(0 < f && 0 < t)) {
                            i[g] = a = 0;
                            continue;
                        }
                        d = D.ugen.playBuffer.resetIndex(r, p, m);
                    }
                    a = b.interpolate(d, l), i[g] = a, d += o.stepSize * r;
                }
                o.idx = d, o.unscaledValue = a, b.mulAdd(e), o.value = D.ugen.lastOutputValue(e, i);
            ...
            return f.gen = function(e) {
                for (var t, n, r, a = f.model, o = a.strides.phase, i = f.output, u = f.inputs.channel.output[0], s = f.inputs.phase.output, l = f.buffer.data.channels[u], c = l.length, d = n = 0; d < e; d++, 
                n += o) t = s[n] * c, r = f.interpolate(t, l), i[d] = r;
                a.unscaledValue = r, f.mulAdd(e), a.value = D.ugen.lastOutputValue(e, i);
            ...
            return y.gen = function(e) {
                var t, n = y.model, r = y.output, a = y.inputs, o = y.buffer, i = y.multiInputs.sources, u = i.length, s = o.data.channels, l = o.format.numSampleFrames, c = a.start.output[0], d = a.loop.output[0];
                for (n.prevStart !== c && (n.prevStart = c, n.writeIdx = Math.floor(c)), t = 0; t < u; t++) for (var f = i[t].output, p = s[t], m = r[t], g = n.writeIdx, h = 0; h < e; h++) {
                    var v = f[h];
                    m && (m[h] = v), g < l ? p[g] = v : 0 < d && (p[g = Math.floor(c)] = v), g++;
                }
                n.writeIdx = g, y.mulAdd(e);
            }, y.createBuffer = function(e, t) {
                for (var n = e.options, r = n.audioSettings, a = n.buffers, o = e.multiInputs.sources.length, i = Math.round(e.options.duration * r.rates.audio), u = new Array(o), s = 0; s < o; s++) u[s] = new Float32Array(i);
                var l = D.bufferDesc(u, r.rates.audio, o);
            ...
            return s.krGen = function(e) {
                for (var t = s.model, n = s.output, r = s.inputs.channel.output[0], a = s.buffer.data.channels[r], o = s.buffer.format.sampleRate, i = a.length / o, u = 0; u < e; u++) n[u] = i;
                t.unscaledValue = i, s.mulAdd(e), t.value = D.ugen.lastOutputValue(e, n);
            ...
            return i.krGen = function(e) {
                for (var t = i.model, n = i.output, r = i.inputs.channel.output[0], a = i.buffer.data.channels[r].length, o = 0; o < e; o++) n[o] = a;
                t.unscaledValue = a, i.mulAdd(e), t.value = D.ugen.lastOutputValue(e, n);
            ...
            var i = D.ugen(e, t, n);
            return i.krGen = function(e) {
                for (var t = i.model, n = i.output, r = t.unscaledValue, a = 0; a < e; a++) n[a] = r;
                i.mulAdd(e), t.value = D.ugen.lastOutputValue(e, n);
            }, i.onInputChanged = function(e) {
            ...
            return T.gen = function(e) {
                for (var t, n, r, a, o, i, u, s, l, c = T.model, d = c.strides, f = T.output, p = T.inputs, m = T.buffers, g = m.length - 1, h = c.prevTrigger, v = c.maxVoices, y = c.activeVoices, b = c.freeVoices, k = p.trigger.output, S = d.trigger, C = 0, x = p.bufferIndex.output, A = d.bufferIndex, w = 0, I = p.speed.output, N = d.speed, M = 0, P = T.inputs.channel.output[0], O = 0; O < e; O++) {
                    if (0 < (t = k[C]) && h <= 0 && y.length < v) {
                        if (r = Math.round(x[w] * g), r = Math.max(0, r), !(a = m[r = Math.min(r, g)])) continue;
                        (n = b.pop()).speed = I[M], n.currentIdx = 0, n.writePos = O, n.buffer = a.data.channels[P], 
                        y.push(n);
                    }
                    C += S, M += N, w += A, f[O] = 0, h = t;
                }
                for (o = 0; o < y.length; ) {
                    for (i = (n = y[o]).buffer, u = Math.min(i.length - n.currentIdx, e), s = n.writePos; s < u; s++) l = T.interpolate ? T.interpolate(n.currentIdx, i) : i[0 | n.currentIdx], 
                    f[s] += l, n.currentIdx += n.speed;
                    n.currentIdx >= i.length ? (b.push(n), y.splice(o, 1)) : (n.writePos = 0, o++);
                }
                c.prevTrigger = h, c.unscaledValue = l, T.mulAdd(e), c.value = D.ugen.lastOutputValue(e, f);
            }, T.init = function() {
                ...
                for (var e, t = T.enviro.buffers, n = T.options.bufferIDs, r = T.buffers.length = 0; r < n.length; r++) e = t[n[r]], 
                T.buffers.push(e);
            ...
            return D.ugen.chopBuffer.randomIndex(n.start.output[0], r) * t.lastIdx;
    ...
    !function() {
        ...
        D.ugen.distortion = function(e, t, n) {
            var f = D.ugen(e, t, n);
            return f.gen = function(e) {
                for (var t, n, r, a, o = f.model, i = f.output, u = f.inputs.source.output, s = o.strides.source, l = f.inputs.gain.output, c = o.strides.gain, d = r = a = 0; d < e; d++, 
                r += s, a += c) n = 1.5 * (t = u[r] * l[a]) - .5 * t * t * t, i[d] = n;
                o.unscaledValue = n, f.mulAdd(e), o.value = D.ugen.lastOutputValue(e, i);
            }, f.onInputChanged(), f;
            ...
            var s = D.ugen(e, t, n);
            return s.gen = function(e) {
                for (var t, n, r = s.model, a = s.output, o = s.inputs.source.output, i = r.strides.source, u = n = 0; u < e; u++, 
                n += i) t = Math.tanh(o[n]), a[u] = t;
                r.unscaledValue = t, s.mulAdd(e), r.value = D.ugen.lastOutputValue(e, a);
            }, s.onInputChanged(), s;
            ...
            return m.gen = function(e) {
                for (var t, n, r, a, o, i, u = m.model, s = m.output, l = m.inputs.source.output, c = u.strides.source, d = m.inputs.amount.output, f = u.strides.amount, p = o = i = 0; p < e; p++, 
                o += c, i += f) t = l[o], n = d[i], a = t * ((r = Math.abs(t)) + n) / (t * t + (n - 1) * r + 1), 
                s[p] = a;
                u.unscaledValue = a, m.mulAdd(e), u.value = D.ugen.lastOutputValue(e, s);
            }, m.onInputChanged(), m;
        ...
        D.ugen.distortion.tarrabiaDeJong = function(e, t, n) {
            var m = D.ugen(e, t, n);
            return m.gen = function(e) {
                for (var t, n, r, a, o, i, u = m.model, s = m.output, l = m.inputs.source.output, c = u.strides.source, d = m.inputs.amount.output, f = u.strides.amount, p = a = o = 0; p < e; p++, 
                a += c, o += f) t = l[a], 1 <= (n = d[o]) ? n = .9999999999999999 : n < -1 && (n = -1), 
                r = (1 + (i = 2 * n / (1 - n))) * t / (1 + i * Math.abs(t)), s[p] = r;
                u.unscaledValue = r, m.mulAdd(e), u.value = D.ugen.lastOutputValue(e, s);
            }, m.onInputChanged(), m;
        ...
        D.ugen.distortion.gloubiBoulga = function(e, t, n) {
            var m = D.ugen(e, t, n);
            return m.gen = function(e) {
                for (var t, n, r, a, o, i, u = m.model, s = m.output, l = m.inputs.source.output, c = u.strides.source, d = m.inputs.gain.output, f = u.strides.gain, p = n = r = 0; p < e; p++, 
                n += c, r += f) a = .686306 * (l[n] * d[r]), o = 1 + Math.exp(-.75 * Math.sqrt(Math.abs(a))), 
                t = ((i = Math.exp(a)) - Math.exp(-a * o)) / (i + Math.exp(-a)), s[p] = t;
                u.unscaledValue = t, m.mulAdd(e), u.value = D.ugen.lastOutputValue(e, s);
            }, m.onInputChanged(), m;
    ...
    !function() {
        ...
        D.envelope = {}, D.envelope.makeCreator = function(r, a) {
            ...
            var t, n = "string" == typeof e ? m.invokeGlobalFunction(e) : e.type ? m.invokeGlobalFunction(e.type, [ e ]) : e;
            return n.curves && !n.curve && (n.curve = n.curves), D.isIterable(n.curve) || (t = n.levels.length - 1, 
            n.curve = D.fillBufferWithValue(new Array(t), n.curve)), D.envelope.validate(n, !0), 
            n;
            ...
            return l.gen = function(e) {
                for (var t = l.model, n = t.stepSize, r = t.numSteps, a = e <= r ? e : r, o = e - a, i = t.level, u = l.output, s = 0; s < a; s++) u[s] = i, 
                r--, i += n;
                if (0 < o) for (s = 0; s < o; s++) u[s] = i;
                t.level = t.unscaledValue = i, t.numSteps = r, l.mulAdd(e), t.value = D.ugen.lastOutputValue(e, u);
            ...
            var l = D.ugen(e, t, n);
            return l.gen = function(e) {
                for (var t = l.model, n = t.multiplier, r = t.numSteps, a = e <= r ? e : r, o = e - a, i = t.level, u = l.output, s = 0; s < a; s++) u[s] = i, 
                r--, i *= n;
                if (0 < o) for (s = 0; s < o; s++) u[s] = i;
                t.level = t.unscaledValue = i, t.numSteps = r, l.mulAdd(e), t.value = D.ugen.lastOutputValue(e, u);
            }, l.onInputChanged = function() {
            ...
            return s.krGen = function(e) {
                ...
                for (var t = s.model, n = s.output, r = s.inputs, a = r.gate.output, o = r.timeScale.output[0], i = 0; i < e; i++) D.ugen.envGen.checkGate(s, a[i], o), 
                s.lineGen.gen(1, i, n, t), t.numSegmentSamps--, t.numSegmentSamps <= 0 && D.ugen.envGen.nextStage(s, o);
                s.mulAdd(e), t.value = D.ugen.lastOutputValue(e, n);
            }, s.onInputChanged = function(e) {
            ...
            var r, a = t.levels[n.stage], o = 0 === n.stage || n.stage > n.numStages ? 1 / 0 : (r = t.times[n.stage - 1] * e, 
            Math.max(1, Math.round(r * n.sampleRate)));
            n.numSegmentSamps = o, n.destination = a;
        }, D.ugen.envGen.lineGenForStage = function(e, t, n) {
            var r, a = t.curve, o = 0 === n.stage || n.stage > n.numStages ? D.line.constant : (r = a[n.stage - 1], 
            n.currentCurve = r, D.lineGenerator(r));
            return D.ugen.envGen.setupStage(e, t, n), o.init(n), o;
    ...
    !function() {
        ...
        D.ugen.lag = function(e, t, n) {
            ...
            var C = D.ugen(e, t, n);
            return C.gen = function(e) {
                for (var t, n, r, a, o, i, u = C.model, s = C.inputs, l = C.output, c = s.source.output, d = u.strides.source, f = s.resonance.output, p = u.strides.resonance, m = s.cutoff.output, g = u.strides.cutoff, h = u.f, v = u.fSq, y = u.fSqSq, b = u.oneMinusF, k = u.fb, S = t = n = r = 0; S < e; S++, 
                t += d, n += p, r += g) a = m[r], o = f[n], a !== u.prevCutoff && (a > u.nyquistRate && (a = u.nyquistRate), 
                h = u.f = a / u.nyquistRate * 1.16, v = u.fSq = h * h, y = u.fSqSq = v * v, b = u.oneMinusF = 1 - h, 
                u.prevRes = void 0), o !== u.prevRes && (4 < o ? o = 4 : o < 0 && (o = 0), k = u.fb = o * (1 - .15 * v)), 
                i = c[t] - u.out4 * k, i *= .35013 * y, u.out1 = i + .3 * u.in1 + b * u.out1, u.in1 = i, 
                u.out2 = u.out1 + .3 * u.in2 + b * u.out2, u.in2 = u.out1, u.out3 = u.out2 + .3 * u.in3 + b * u.out3, 
                u.in3 = u.out2, u.out4 = u.out3 + .3 * u.in4 + b * u.out4, u.in4 = u.out3, l[S] = u.out4;
                u.unscaledValue = u.out4, C.mulAdd(e), u.value = D.ugen.lastOutputValue(e, l);
            }, C.onInputChanged(), C;
            ...
            return l.gen = function(e) {
                ...
                var t;
                D.onMulAddInputChanged(l), e && "maxTime" !== e || (t = l.model.sampleRate * l.inputs.maxTime.output[0], 
            ...
            var s = D.ugen(e, t, n);
            return s.gen = function(e) {
                for (var t, n = s.model, r = s.inputs, a = s.output, o = r.source.output, i = n.prevVal, u = 0; u < e; u++) a[u] = t = i, 
                i = o[u];
                n.prevVal = i, n.unscaledValue = t, s.mulAdd(e), n.value = D.ugen.lastOutputValue(e, a);
            }, s.onInputChanged = function() {
                D.onMulAddInputChanged(s);
            }, s.onInputChanged(), s;
            ...
            y.gen = function(e) {
                for (var t, n = y.model, r = y.inputs, a = y.output, o = r.source.output, i = r.mix.output[0], u = 1 - i, s = .28 * r.room.output[0] + .7, l = .4 * r.damp.output[0], c = 1 - l, d = 0; d < e; d++) {
                    for (var f = o[d], p = .015 * f, m = 0; m < y.buffers_a.length; m++) ++y.bufferindices_a[m] === y.allpassTunings[m] && (y.bufferindices_a[m] = 0), 
                    ...
                    y.filtery_a[0] = y.filterx_a[0] - y.filtery_a[1], t = u * f + i * y.filtery_a[0], 
                    a[d] = t;
                }
                n.unscaledValue = t, y.mulAdd(e), n.value = D.ugen.lastOutputValue(e, a);
    ...
    !function() {
        ...
        D.ugen.gate = function(e, t, n) {
            var h = D.ugen(e, t, n);
            return h.gen = function(e) {
                for (var t, n, r, a = h.model, o = a.strides, i = h.output, u = h.inputs, s = u.source.output, l = u.sideChain.output, c = o.sideChain, d = u.threshold.output, f = o.threshold, p = h.options.holdLastValue, m = a.lastValue, g = t = n = 0; g < e; g++, 
                t += c, n += f) l[t] >= d[n] ? i[g] = r = m = s[g] : i[g] = r = p ? m : 0;
                a.lastValue = m, a.unscaledValue = r, h.mulAdd(e), a.value = D.ugen.lastOutputValue(e, i);
    ...
    !function() {
        ...
        D.ugen.triggerGrains = function(e, t, n) {
            ...
            return w.gen = function(e) {
                for (var t, n, r, a, o, i, u = w.model, s = w.inputs, l = w.output, c = s.channel.output[0], d = w.buffer.data.channels[c], f = w.buffer.format.sampleRate, p = s.dur.output[0], m = s.amp.output, g = s.centerPos.output, h = s.trigger.output, v = s.speed.output, y = w.options.grainEnv, b = e - 1, k = 0, S = 0, C = 0, x = 0, A = 0; A < e; A++) {
                    if (0 < h[S] && u.prevTrigger <= 0 && u.activeGrains.length < u.maxNumGrains) {
                        for ((r = u.freeGrains.pop()).numSamps = u.sampleRate * p, r.centerIdx = r.numSamps / 2 * u.stepSize, 
                        r.envScale = w.options.grainEnv.length / r.numSamps, r.sampIdx = 0, r.amp = m[C], 
                        a = g[k] * f - r.centerIdx; a < 0; ) a += d.length;
                        r.readPos = a, r.writePos = A, r.speed = v[x], u.activeGrains.push(r);
                    }
                    u.prevTrigger = h[S], l[A] = 0, k += u.strides.centerPos, S += u.strides.trigger, 
                    C += u.strides.amp, x += u.strides.speed;
                }
                for (t = 0; t < u.activeGrains.length; ) {
                    for (n = (r = u.activeGrains[t]).writePos; n < Math.min(n + (r.numSamps - r.sampIdx), e); n++) o = w.interpolate(r.readPos, d), 
                    i = D.interpolate.linear(r.sampIdx * r.envScale, y), l[n] += o * i * r.amp, r.readPos = (r.readPos + u.stepSize * r.speed) % d.length, 
                    r.sampIdx++;
                    r.sampIdx >= r.numSamps ? (u.freeGrains.push(r), u.activeGrains.splice(t, 1)) : (t++, 
                    r.writePos = n % e);
                }
                u.unscaledValue = l[b], w.mulAdd(e), u.value = l[b];
    ...
    !function() {
        ...
        D.ugen.math = function(e, t, n) {
            ...
            return u.copyGen = function(e) {
                for (var t, n = u.model, r = u.output, a = u.inputs.sources.output, o = 0; o < e; o++) t = a[o], 
                r[o] = t;
                n.unscaledValue = t, u.mulAdd(e), n.value = D.ugen.lastOutputValue(e, r);
            }, u.sumGen = function(e) {
    ...
    !function() {
        ...
        D.ugen.midiFreq = function(e, t, n) {
            ...
            return d.gen = function(e) {
                for (var t, n = d.model, r = n.a4, a = r.freq, o = r.noteNum, i = n.notesPerOctave, u = d.inputs.note.output, s = d.output, l = 0, c = 0; l < e; l++, 
                c += n.strides.note) s[l] = t = D.midiFreq(u[c], a, o, i);
                n.unscaledValue = t, d.mulAdd(e), n.value = D.ugen.lastOutputValue(e, s);
            }, d.init = function() {
            ...
            var u = D.ugen(e, t, n);
            return u.gen = function(e) {
                for (var t, n = u.model, r = u.inputs.velocity.output, a = u.output, o = 0, i = 0; o < e; o++, 
                i += n.strides.velocity) a[o] = t = r[i] / 127;
                n.unscaledValue = t, u.mulAdd(e), n.value = D.ugen.lastOutputValue(e, a);
            }, u.init = function() {
                u.onInputChanged();
            }, u.init(), u;
    ...
    !function() {
        ...
        D.ugen.pan2 = function(e, t, n) {
            ...
            return p.gen = function(e) {
                for (var t, n, r = p.model, a = p.output, o = a[0], i = a[1], u = p.inputs, s = u.source.output, l = u.pan.output, c = 0, d = 0; c < e; c++, 
                d += r.strides.pan) t = s[c], n = .5 * l[d] + .5, i[c] = t * Math.sin(n * D.HALFPI), 
                o[c] = t * Math.cos(n * D.HALFPI);
                var f = e - 1;
                r.value[0] = a[0][f], r.value[1] = a[1][f];
            }, p.init = function() {
    ...
    !function() {
        ...
        D.ugen.osc = function(e, t, n) {
            var h = D.ugen(e, t, n);
            return h.gen = function(e) {
                for (var t, n, r = h.model, a = h.inputs, o = a.freq.output, i = a.phase.output, u = a.table, s = r.tableLen, l = r.tableIncHz, c = r.tableIncRad, d = h.output, f = r.phase, p = 0, m = 0, g = 0; p < e; p++, 
                m += r.strides.phase, g += r.strides.freq) s <= (t = f + i[m] * c) ? t -= s : t < 0 && (t += s), 
                d[p] = n = h.interpolate(t, u), s <= (f += o[g] * l) ? f -= s : f < 0 && (f += s);
                r.phase = f, r.unscaledValue = n, h.mulAdd(e), r.value = D.ugen.lastOutputValue(e, d);
            }, h.onInputChanged = function(e) {
                var t, n;
                D.ugen.osc.onInputChanged(h), e && "table" !== e || (t = h.model, (n = h.inputs.table).length < 1 && (n = h.inputs.table = D.ugen.osc.emptyTable), 
                t.tableLen = n.length, t.tableIncHz = t.tableLen / t.sampleRate, t.tableIncRad = t.tableLen / D.TWOPI);
            }, h.onInputChanged(), h;
        ...
        D.ugen.sin = function(e, t, n) {
            var d = D.ugen(e, t, n);
            return d.gen = function(e) {
                for (var t, n = d.model, r = d.inputs.freq.output, a = d.inputs.phase.output, o = d.output, i = n.phase, u = n.sampleRate, s = 0, l = 0, c = 0; s < e; s++, 
                l += n.strides.phase, c += n.strides.freq) o[s] = t = Math.sin(i + a[l]), i += r[c] / u * D.TWOPI;
                n.phase = i, n.unscaledValue = t, d.mulAdd(e), n.value = D.ugen.lastOutputValue(e, o);
            }, d.onInputChanged = function() {
            ...
            var c = D.ugen(e, t, n);
            return c.gen = function(e) {
                for (var t, n = c.model, r = c.inputs.freq.output, a = c.output, o = n.scale, i = c.inputs.phase.output[0], u = n.phase, s = 0, l = 0; s < e; s++, 
                l += n.strides.freq) a[s] = t = u + i, 1 <= (u += r[l] * o) ? u -= 2 : u <= -1 && (u += 2);
                n.phase = u, n.unscaledValue = t, c.mulAdd(e), n.value = D.ugen.lastOutputValue(e, a);
            }, c.onInputChanged = function() {
                var e = c.model;
            ...
            var f = D.ugen(e, t, n);
            return f.gen = function(e) {
                for (var t, n = f.inputs, r = f.model, a = n.freq.output, o = r.freqInc, i = n.width.output[0], u = f.output, s = r.scale, l = void 0 !== r.phase ? r.phase : n.phase.output[0], c = 0, d = 0; c < e; c++, 
                d += o) 1 <= l ? (--l, u[c] = t = i < .5 ? 1 : -1) : u[c] = t = l < i ? 1 : -1, 
                l += a[d] * s;
                r.phase = l, r.unscaledValue = t, f.mulAdd(e), r.value = D.ugen.lastOutputValue(e, u);
    ...
    !function() {
        ...
        D.ugen.dust = function(l, e, t) {
            var c = D.ugen(l, e, t);
            return c.gen = function(e) {
                for (var t, n, r, a = c.model, o = c.output, i = l.density.output[0], u = i !== a.density ? (a.density = i, 
                t = a.threshold = i * a.sampleDur, a.scale = 0 < t ? 1 / t : 0) : (t = a.threshold, 
                a.scale), s = 0; s < e; s++) r = (n = Math.random()) < t ? n * u : 0, o[s] = r;
                a.unscaledValue = r, c.mulAdd(e), a.value = D.ugen.lastOutputValue(e, o);
            }, c.onInputChanged(), c;
            ...
            return o.gen = function(e) {
                for (var t, n = o.model, r = o.output, a = 0; a < e; a++) r[a] = t = D.randomAudioValue();
                n.unscaledValue = t, o.mulAdd(e), n.value = D.ugen.lastOutputValue(e, r);
            }, o.onInputChanged(), o;
            ...
            var d = D.ugen(e, t, n);
            return d.gen = function(e) {
                for (var t, n, r, a = d.model, o = a.state, i = d.a, u = d.p, s = a.offset, l = d.output, c = 0; c < e; c++) {
                    for (t = r = 0; t < o.length; t++) n = Math.random(), o[t] = u[t] * (o[t] - n) + n, 
                    r += i[t] * o[t];
                    r = 2 * r - s, l[c] = r;
                }
                a.unscaledValue = r, d.mulAdd(e), a.value = D.ugen.lastOutputValue(e, l);
            }, d.init = function() {
            ...
            var l = D.ugen(s, e, t);
            return l.gen = function(e) {
                var t, n, r = l.model, a = s.freq.output[0], o = e, i = l.output, u = 0, a = .001 < a ? a : .001;
                do {
            ...
            var i = D.ugen(e, t, n);
            return i.gen = function(e) {
                for (var t, n = i.model, r = i.generator, a = i.output, o = 0; o < e; o++) a[o] = t = r.uniform(-1, 1);
                n.unscaledValue = t, i.mulAdd(e), n.value = D.ugen.lastOutputValue(e, a);
            }, i.onInputChanged = function(e) {
            ...
            return l.gen = function(e) {
                for (var t, n, r = l.model, a = l.generator, o = l.output, i = l.inputs.lambda.output, u = l.model.strides.lambda, s = t = 0; s < e; s++, 
                t += u) o[s] = n = a.exponential(i[t]);
                r.unscaledValue = n, l.mulAdd(e), r.value = D.ugen.lastOutputValue(e, o);
            }, l;
            ...
            return p.gen = function(e) {
                for (var t, n, r, a = p.model, o = p.inputs, i = p.generator, u = p.output, s = a.strides.alpha, l = o.alpha.output, c = a.strides.beta, d = o.beta.output, f = t = n = 0; f < e; f++, 
                t += s, n += c) u[f] = r = i.gamma(l[t], d[n]);
                a.unscaledValue = r, p.mulAdd(e), a.value = D.ugen.lastOutputValue(e, u);
            }, p;
            ...
            var p = D.ugen.random(e, t, n);
            return p.gen = function(e) {
                for (var t, n, r, a = p.model, o = p.output, i = p.inputs, u = p.generator, s = a.strides.mu, l = i.mu.output, c = a.strides.sigma, d = i.sigma.output, f = t = n = 0; f < e; f++, 
                t += s, n += c) o[f] = r = u.normal(l[t], d[n]);
                a.unscaledValue = r, p.mulAdd(e), a.value = D.ugen.lastOutputValue(e, o);
            }, p;
            ...
            var l = D.ugen.random(e, t, n);
            return l.gen = function(e) {
                for (var t, n, r = l.model, a = l.generator, o = l.output, i = l.model.strides.alpha, u = l.inputs.alpha.output, s = t = 0; s < e; s++, 
                t += i) o[s] = n = a.pareto(u[t]);
                r.unscaledValue = n, l.mulAdd(e), r.value = D.ugen.lastOutputValue(e, o);
            }, l;
            ...
            var l = D.ugen.random(e, t, n);
            return l.gen = function(e) {
                for (var t, n, r = l.model, a = l.generator, o = l.output, i = l.model.strides.mode, u = l.inputs.mode.output, s = t = 0; s < e; s++, 
                t += i) o[s] = n = a.triangular(-1, 1, u[t]);
                r.unscaledValue = n, l.mulAdd(e), r.value = D.ugen.lastOutputValue(e, o);
            }, l;
            ...
            return p.gen = function(e) {
                for (var t, n, r, a = p.model, o = p.inputs, i = p.generator, u = p.output, s = a.strides.alpha, l = o.alpha.output, c = a.strides.beta, d = o.beta.output, f = t = n = 0; f < e; f++, 
                t += s, n += c) u[f] = r = i.weibull(l[t], d[n]);
                a.unscaledValue = r, p.mulAdd(e), a.value = D.ugen.lastOutputValue(e, u);
            }, p;
    ...
    !function() {
        ...
        D.ugen.change = function(e, t, n) {
            ...
            var c = D.ugen(e, t, n);
            return c.gen = function(e) {
                for (var t, n, r = c.model, a = c.output, o = c.inputs.list, i = o.length - 1, u = c.inputs.index.output, s = 0, l = 0; s < e; s++, 
                l += r.strides.index) n = Math.round(u[l] * i), n = Math.max(0, n), t = o[n = Math.min(n, i)], 
                a[s] = t;
                r.unscaledValue = t, c.mulAdd(e), r.value = D.ugen.lastOutputValue(e, a);
            }, c.onInputChanged(), c;
    ...
    !function() {
        ...
        D.ugen.valueChangeTrigger = function(e, t, n) {
            var u = D.ugen(e, t, n);
            return u.gen = function(e) {
                for (var t, n = u.model, r = u.inputs.source.output, a = u.output, o = 0, i = 0; o < e; o++, 
                i += n.strides.source) t = r[i], a[o] = t !== n.prevVal ? 1 : 0, n.prevVal = t;
            ...
            var p = D.ugen(e, t, n);
            return p.gen = function(e) {
                for (var t, n, r, a, o = p.model, i = p.inputs.source.output, u = o.strides.source, s = p.inputs.duration.output, l = o.strides.duration, c = o.prevDur, d = p.output, f = t = n = 0; f < e; f++, 
                t += u, n += l) r = i[t], (a = s[n]) !== c && (o.prevDur = a, o.remainingOpenSamples = 0 < r ? 0 < a ? o.sampleRate * a : 1 : 0), 
                0 < o.remainingOpenSamples ? (d[f] = r, o.remainingOpenSamples--) : d[f] = 0;
                o.value = o.unscaledValue = D.ugen.lastOutputValue(e, d);
            }, p.onInputChanged = function(e) {
            ...
            return k.gen = function(e) {
                for (var t, n, r, a, o = k.model, i = k.options, u = k.output, s = k.inputs, l = o.strides.trigger, c = o.strides.source, d = s.trigger.output, f = s.source.output, p = i.callback, m = p.func, g = p.args, h = p.this, v = o.lastArgIdx, y = o.prevTrig, b = t = n = 0; b < e; b++, 
                t += l, n += c) r = d[t], a = f[n], 0 < r && y <= 0 && m && (g[v] = a, m.apply(h, g)), 
                u[b] = a, y = r;
                o.prevTrig = y, o.value = o.unscaledValue = a;
    ...
    return function() {
        ...
        m.registerNamespace("flock.ugen"), D.ugen.scope = function(e, t, n) {
            var u = D.ugen(e, t, n);
            return u.gen = function(e) {
                for (var t = u.model, n = u.inputs.source.output, r = t.spf, a = t.bufIdx, o = t.scope.values, i = 0; i < e; i++) o[a] = n[i], 
                a < r ? a += 1 : (a = 0, u.scopeView.refreshView());
                t.bufIdx = a, t.value = t.unscaledValue = D.ugen.lastOutputValue(e, n);
            }, u.onInputChanged = function() {
            ...
            return d.exponentialGen = function(e) {
                ...
                for (var t = d.model, n = d.output, r = D.ugen.mouse.cursor.normalize(d.target, t), a = 0; a < e; a++) n[a] = r * d.inputs.mul.output[0] + d.inputs.add.output[0];
                t.value = t.unscaledValue = D.ugen.lastOutputValue(e, n);
